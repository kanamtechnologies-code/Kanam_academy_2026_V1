    ...
    <SpotlightTour
      ...
      steps={[
        ...
        },
        {
          ...
          title: "Practice lives on Exercises",
          body: "After you finish the lesson slides (and any questions), **Exercises** unlocks. That's your workspace: editor, **Run & check**, and console. This tour peeks ahead so you know where practice happens.",
          action: "Follow the gold arrow and open **Exercises** (tour preview).",
