...
export function AppChrome({ children }: { children: React.ReactNode }) {
  return (
    <LessonHelpPocketProvider>
      <header
        className="sticky top-0 z-[80] max-w-[100vw] overflow-x-clip border-b-2 border-[rgb(var(--accent-rgb)/0.98)] bg-gradient-to-r from-[rgb(var(--brand-2-rgb)/0.98)] via-[rgb(var(--brand-rgb)/0.92)] to-[rgb(var(--accent-rgb)/0.86)] shadow-[0_12px_32px_rgba(15,23,42,0.28),0_4px_12px_rgba(15,23,42,0.14)]"
