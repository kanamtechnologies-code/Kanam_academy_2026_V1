...
function ApCspPrepGlyph({ className, title }: GlyphProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden={!title} role={title ? "img" : undefined}>
      {title ? <title>{title}</title> : null}
      <rect x="3" y="2.5" width="18" height="19" rx="2" fill="currentColor" />
      <rect x="6" y="5.5" width="12" height="2.25" rx="0.5" fill="#fff" />
      <rect x="6" y="9.25" width="8" height="2" rx="0.5" fill={ACCENT} />
      <rect x="6" y="12.75" width="10" height="2" rx="0.5" fill="#fff" />
      <rect x="6" y="16.25" width="6" height="2" rx="0.5" fill={ACCENT} />
    </svg>
  );
}
...
export const TRACK_ICON_SVG: Record<Track["id"], string> = {
  ...
  "ap-csp-prep": `<svg viewBox="0 0 24 24" fill="none" width="20" height="20" aria-hidden="true"><rect x="3" y="2.5" width="18" height="19" rx="2" fill="currentColor"/><rect x="6" y="5.5" width="12" height="2.25" rx="0.5" fill="#fff"/><rect x="6" y="9.25" width="8" height="2" rx="0.5" fill="#d8c07a"/><rect x="6" y="12.75" width="10" height="2" rx="0.5" fill="#fff"/><rect x="6" y="16.25" width="6" height="2" rx="0.5" fill="#d8c07a"/></svg>`,
