...
const questions: ApCspExamQuestion[] = [
  {
    ...
    choices: [
            "Picking “It guarantees the program will run on every possible device” is a common mix-up that confuses a nearby idea with the right one",
            ...
            "Picking “It ensures the program will never have any runtime errors” is a common mix-up that confuses a nearby idea with the right one",
            "It can seem like it makes testing the finished program unnecessary, but that reading skips the distinction this question is testing",
          ],
    correctIndexes: [1],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "To encrypt data before it is sent over the Internet” belongs to a different situation than the one in the question stem",
            "To compress files so they transfer faster” belongs to a different situation than the one in the question stem",
            "To uniquely identify a device on a network so that data can be routed to it.",
            "To translate domain names directly into finished web pages” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "“increase the physical storage capacity of the device” describes a different situation than the one in the question stem",
            "“permanently erase the user's entire browsing history” describes a different situation than the one in the question stem",
            "remember information such as login status or preferences, and sometimes track a user's activity across visits.",
            "“encrypt the user's entire Internet connection” describes a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "It must finish running completely before the user can do anything” belongs to a different situation than the one in the question stem",
            "It can only produce output and can never accept input” belongs to a different situation than the one in the question stem",
            "Portions of the program run in response to events, such as a user clicking a button or entering input.",
            "It always runs the same fixed sequence of steps and ignores the user” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "Some learners answer “It guarantees that no data packet is ever lost”, yet that does not match the precise idea from the lesson",
            ...
            "It prevents any new devices from ever joining the Internet — familiar wording, wrong fit for what the prompt is actually asking",
            "It can seem like it makes encryption completely unnecessary, but that reading skips the distinction this question is testing",
          ],
    correctIndexes: [1],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "Convert the drawing to binary before they are allowed to use it” belongs to a different situation than the one in the question stem",
            "Pay a mandatory fee to a certificate authority” belongs to a different situation than the one in the question stem",
            "Nothing; they may claim the drawing as entirely their own original work” belongs to a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            ...
            "It removes the need for the programmer to understand her own code” belongs to a different situation than the one in the question stem",
            "It guarantees the program is now completely free of bugs” belongs to a different situation than the one in the question stem",
            "It automatically makes the program run faster” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [0],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "store the packet permanently so it never needs to be sent again” belongs to a different situation than the one in the question stem",
            "encrypt the packet using a certificate authority” belongs to a different situation than the one in the question stem",
            "translate the packet from binary into decimal for the user” belongs to a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            ...
            "“Their devices will automatically gain additional storage space” describes a different situation than the one in the question stem",
            "You might defend “The Internet will permanently stop working for everyone” in casual talk, but it fails the definition used here",
            "You might defend “Binary numbers will no longer be able to represent data” in casual talk, but it fails the definition used here",
          ],
    correctIndexes: [0],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "phishing, which distributes the workload among users” belongs to a different situation than the one in the question stem",
            "overflow, which extends the program's available memory” belongs to a different situation than the one in the question stem",
            "decomposition, which helps manage complexity and supports collaboration.",
            "sampling, which converts the program into digital form” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "To convert the data from digital form into analog form” belongs to a different situation than the one in the question stem",
            ...
            "To guarantee that the data contains no errors” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "A protocol used to transfer web pages between browsers and servers” belongs to a different situation than the one in the question stem",
            "A technique for compressing data without any loss” belongs to a different situation than the one in the question stem",
            "A legitimate security update issued by the operating system's vendor” belongs to a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            "“Big data eliminates any need to protect user privacy” describes a different situation than the one in the question stem",
            "“Larger data sets are always completely free of bias” describes a different situation than the one in the question stem",
            "Patterns and correlations found in very large data sets can reveal insights that smaller samples might miss.",
            "“Big data can only ever be stored in analog form” describes a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "“It makes the user's device run measurably faster” describes a different situation than the one in the question stem",
            "The algorithm guarantees that all recommended content is factually accurate” belongs to a different situation than the one in the question stem",
            "Users will automatically see perfectly balanced information on every topic” belongs to a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            "“It converts the data set into a heuristic” describes a different situation than the one in the question stem",
            "It is required before a computer can connect to the Internet” belongs to a different situation than the one in the question stem",
            "Cleaning and standardizing data helps ensure the analysis produces accurate and meaningful results.",
            "It permanently encrypts the data so no one can read it” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [2],
    explanation:
  ...
  },
  {
    ...
    choices: [
            ...
            "A file that is too large to send by email” belongs to a different situation than the one in the question stem",
            "A program that runs slowly on older hardware” belongs to a different situation than the one in the question stem",
            "A website that uses http instead of https” belongs to a different situation than the one in the question stem",
          ],
    correctIndexes: [0],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "It never requires any maintenance of any kind” belongs to a different situation than the one in the question stem",
            "It stores all of its data using lossy compression” belongs to a different situation than the one in the question stem",
            "It processes data faster than every other system” belongs to a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            "a logic error in the programmer's code” belongs to a different situation than the one in the question stem",
            "lossy compression of the list's data” belongs to a different situation than the one in the question stem",
            "an overflow error caused by too many list elements” belongs to a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            "A rushed pass can land on only a government agency is allowed to delete online posts”; careful readers reject it for this problem",
            "The comment is automatically turned into binary and therefore cannot be deleted” belongs to a different situation than the one in the question stem",
            "“Deleting a post is technically impossible on every system that exists” describes a different situation than the one in the question stem",
  ...
  },
  {
    ...
    choices: [
            ...
            "Only the shorter of the two algorithms can be correct” belongs to a different situation than the one in the question stem",
            "Two different algorithms can never produce the same output” belongs to a different situation than the one in the question stem",
