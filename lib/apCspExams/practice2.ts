...
const questions: ApCspExamQuestion[] = [
  ...
  },
  {
    ...
    choices: [
            "A common mix-up is to treat comments make a program run measurably faster as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "A common mix-up is to treat comments are required for the program to run at all as enough, which confuses a nearby idea with the right one",
            "It can seem like documentation automatically converts logic errors into syntax errors, but that reading skips the distinction this question is testing",
  ...
  },
  {
    ...
    choices: [
            "It can seem like longer addresses automatically encrypt all Internet traffic, but that reading skips the distinction this question is testing",
            ...
            "It can seem like longer addresses make individual web pages load faster, but that reading skips the distinction this question is testing",
            "A common mix-up is to treat iPv6 removes the need for the Domain Name System as enough, which confuses a nearby idea with the right one",
          ],
    correctIndexes: [1],
    explanation:
  ...
  },
  {
    ...
    choices: [
            "It can seem like neither algorithm can ever finish running, but that reading skips the distinction this question is testing",
            ...
            "If the goal were something else, “Algorithm B is always faster because 2 is smaller than n” might work; for this check, it does not",
            "Both algorithms take the same amount of time for every input” is close in topic, but it is the wrong fit for what the prompt asks",
          ],
    correctIndexes: [1],
    explanation:
