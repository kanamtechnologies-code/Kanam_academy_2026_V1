...
export const financeLesson11: AILessonConfig = {
  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `**Auto:** If you drive (or are on a family policy), liability coverage helps if you injure someone or damage their property. Other parts may cover your car after a crash or theft, depending on the policy. Driving without required coverage can mean legal and financial disaster.\n\n**Renters (or dorm/shared housing concepts):** Helps with personal belongings after covered events (theft/fire, depending on policy) and often includes liability if someone is hurt in your space. A landlord's policy usually covers the *building*, not your laptop.\n\n**Health:** Helps share medical costs. Key teen ideas: staying on a parent's plan when eligible, knowing what a deductible/copay means, and using in-network care when required. Exact rules vary — ask trusted adults and read plan summaries.\n\nThis is conceptual awareness, not a shopping recommendation.`,
        bullets: [
          "Auto: liability protects others you might harm.",
  ...
  realWorld:
    "A roommate's guest slips in the apartment. Liability coverage on a renters policy may help with injury costs — while the building owner's policy still wouldn't replace your stolen backpack.",
  quiz: [
    {
      id: "q1",
    ...
    {
      id: "q5",
      question: "Which Coverage Checker habit is smartest before you drive or move out?",
      choices: [
  ...
  reflection: {
    prompt:
      "Pick auto, renters, or health. Write three questions you would ask a parent, guardian, or HR benefits person to understand premium, deductible, and what to do after a claim.",
    placeholder:
      "Example: Health — What plan am I on? What's my deductible? If I need urgent care, what's the first step and what will I pay?",
  },
};
