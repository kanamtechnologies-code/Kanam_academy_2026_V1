    ...
    sections: [
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Her employer made a payroll error and owes her the difference",
            "She must have actually worked fewer hours than she logged",
            "Her real pay rate must be lower than the $18/hour she was told",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "App-based gig income is never taxed, so it's simply more money overall",
            "The gig deposit likely has little or no tax withheld yet, so Priya may still owe some of it later",
            "Her friend's employer must be charging a fee that gig apps don't charge",
            "Retail jobs are required to pay less per hour than gig apps",
          ],
          correctIndex: 1,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Recycle it once he's glanced at the total, since employers keep a copy anyway",
            "Wait until he's 18 to think about any of it, since he was a minor when he earned it",
            "File it somewhere safe with his pay stubs and ask a trusted adult about deadlines and filing help",
            "Assume he owes nothing at all since it was his first year working",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Spend all of it right away since no tax was withheld from any of the payments",
            "Assume the dog-walking app automatically sets aside taxes on his behalf",
            "Only worry about it if his total for the year happens to cross a round number like $1,000",
          ],
          correctIndex: 0,
          explanation:
...
Neither choice is universal — match complexity to support.`,
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Agree — a bigger deposit for the same hours always means better real pay",
            ...
            "Explain that gig apps are required to withhold more tax than traditional employers",
            "Explain that W-2 jobs always end up paying less once bonuses are factored in",
          ],
          correctIndex: 1,
          explanation:
  ...
  quiz: [
    {
      ...
      choices: [
        "Taxes mainly exist to fund refund checks that get sent back every spring",
        "Taxes exist because employers are required to invent extra paperwork",
        "Taxes fund shared public costs — like roads, schools, and public safety — that everyone benefits from",
        "Taxes exist only to cover the government's own office expenses, not public services",
      ],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      choices: [
        "The $17/hour must be fake advertising that won't actually be honored",
        "His net pay will end up higher than $17/hour once a refund is added back in",
    ...
    },
    {
      ...
      choices: [
        ...
        "Gig apps must pay a higher base rate than traditional employers",
        "W-2 employers withhold extra pay as a new-hire penalty",
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
        "Only keep pay stubs if a paycheck ever looks obviously wrong",
        "Keep her W-2/1099 forms and pay stubs together, and ask a trusted adult about deadlines and filing help",
        "Wait for her school to file a return on her behalf automatically",
        "Assume the exact filing rules that applied to her older sibling apply to her the same way",
      ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
        "It's a reward the government pays out for filing early",
        "It's extra money the government adds on top of what she actually earned",
        "It's money she overpaid during the year through withholding, now being returned to her",
        "It's a sign that she filled out her tax forms incorrectly",
      ],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      choices: [
        ...
        "Withholding — the process that determined how much tax came out of his pay all year",
        "Filing — the act of submitting a tax return for the year",
        "A W-4 election — the form that set his withholding amount",
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
        "Agree — a bigger deposit for the same hours always means higher real pay",
        ...
        "Explain that gig income isn't counted as real income at all",
        "Explain that W-2 paychecks are required by law to be smaller than gig deposits",
      ],
      correctIndex: 1,
      explanation:
