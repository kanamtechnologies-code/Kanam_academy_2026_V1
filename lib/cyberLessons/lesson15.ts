...
Today's lesson: **Risk Analysis & Control Selection**.
    ...
    sections: [
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Club B's risk is actually higher because they use MFA” belongs to a different situation than the one in the question stem",
            "Club A has more exploitable vulnerabilities, so the same threat is more likely to succeed and cause harm",
            "Threats matter more than vulnerabilities in every case” belongs to a different situation than the one in the question stem",
            "It doesn't — risk is identical since the threat is the same” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 1,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Whichever scenario is easiest to imagine in detail” belongs to a different situation than the one in the question stem",
            "The phishing risk, since it combines meaningfully high likelihood with high impact",
            "The dedicated hacker group scenario, since it sounds more serious” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "It can seem like preventive controls alone are always sufficient, but that reading skips the distinction this question is testing",
            "You might defend “Administrative controls are unnecessary if technical controls exist” in casual talk, but it fails the definition used here",
            "It can seem like it's redundant — only one control type is ever necessary, but that reading skips the distinction this question is testing",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "“Transfer” describes a different situation than the one in the question stem",
            "“Mitigate” describes a different situation than the one in the question stem",
            "“Accept” describes a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Panic and add controls until risk theoretically reaches exactly zero” belongs to a different situation than the one in the question stem",
            "“Conclude the controls were pointless since risk isn't zero” describes a different situation than the one in the question stem",
            "A rushed pass can land on claim the account is now completely risk-free”; careful readers reject it for this problem",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "“It makes the document longer, which looks more thorough” describes a different situation than the one in the question stem",
            "“Owners and review dates are required by law for all documents” describes a different situation than the one in the question stem",
            "“It has no real benefit over a simple one-time list” describes a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
...
**Explain the tradeoff:** stronger controls often cost time or convenience; weaker ones leave residual risk. Recommend the option that clears the efficiency × feasibility × ethics bar, then document residual risk.`,
        checkIn: {
          ...
          choices: [
            "A common mix-up is to treat hope officers stay careful — cheapest, so always best as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            ...
            "A common mix-up is to treat delete the Gmail account and stop emailing sponsors as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "A common mix-up is to treat install covert keyloggers on every member's phone as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
          ],
          correctIndex: 1,
          explanation:
  ...
  quiz: [
    {
      ...
      choices: [
            "A type of phishing email” belongs to a different situation than the one in the question stem",
            "Any software update” belongs to a different situation than the one in the question stem",
            "Only malware” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "Risk only exists for large corporations” belongs to a different situation than the one in the question stem",
            "Likelihood and impact are irrelevant to this situation” belongs to a different situation than the one in the question stem",
            "There is a threat but no vulnerability at all” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "A common mix-up is to treat accepting a high risk with no thought as enough, which confuses a nearby idea with the right one",
            "A common mix-up is to treat transferring risk to malware as enough, which confuses a nearby idea with the right one",
            ...
            "A common mix-up is to treat a detective control only as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
          ],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "A common mix-up is to treat choose B because more expensive tools are always better as enough, which confuses a nearby idea with the right one once the deciding rule is named clearly",
            ...
            "It can seem like never — all risks must be reduced to exactly zero before any activity continues, but that reading skips the distinction this question is testing",
            "It can seem like accept Gmail takeover risk with no MFA because setup takes 20 minutes, but that reading skips the distinction this question is testing",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            ...
            "It doesn't differ — identical threats always mean identical risk” belongs to a different situation than the one in the question stem",
            "Threats matter more than vulnerabilities in every scenario” belongs to a different situation than the one in the question stem",
            "Risk is only about impact, never about likelihood” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "Risk that only applies to large organizations” belongs to a different situation than the one in the question stem",
            "The risk that remains after controls have been applied — it is never fully zero",
            "Risk that existed only before any controls were considered” belongs to a different situation than the one in the question stem",
            "A type of malware that specifically targets leftover files” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "“A risk register replaces the need for any controls” describes a different situation than the one in the question stem",
            "It assigns owners and review dates, turning risk management into an ongoing, maintained habit as circumstances change",
            "Risk registers are only useful for large companies with dedicated staff” belongs to a different situation than the one in the question stem",
            "“It isn't more useful — a one-time list is always sufficient” describes a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "A common mix-up is to treat pick the flashiest tool and skip documenting residual risk as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            ...
            "A common mix-up is to treat ethics never matter if a control reduces risk even slightly as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "A common mix-up is to treat feasibility only matters for large corporations as enough, which confuses a nearby idea with the right one when checked against the lesson definition once the deciding rule is named clearly",
          ],
      correctIndex: 1,
      explanation:
