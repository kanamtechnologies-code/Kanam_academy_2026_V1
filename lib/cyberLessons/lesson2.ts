...
export const cyberLesson2: AILessonConfig = {
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
        "A way to make MFA stronger on purpose",
    ...
    },
    {
      ...
      choices: [
        ...
        "It never needs to be plugged in or tapped",
        "It removes the need for a password entirely in all systems",
        "It is always free and built into every device",
      ],
      correctIndex: 0,
      explanation:
