...
Today's lesson: **CIA Triad, Auth & Tradeoffs**.
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            ...
            "A common mix-up is to treat strict lockouts only help Availability and never affect Confidentiality as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "A common mix-up is to treat there is no tradeoff — maximum lockout is always best as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "A common mix-up is to treat lockouts only matter for gaming accounts, not school portals as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
          ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "A common mix-up is to treat because MFA removes the need for authorization checks as enough, which confuses a nearby idea with the right one when checked against the lesson definition once the deciding rule is named clearly",
            ...
            "A common mix-up is to treat because Integrity only applies to documents printed on paper as enough, which confuses a nearby idea with the right one when checked against the lesson definition once the deciding rule is named clearly",
            "A common mix-up is to treat you shouldn't — a strong password alone always protects all three CIA goals as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
          ],
      correctIndex: 1,
      explanation:
