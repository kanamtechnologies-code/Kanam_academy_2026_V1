...
export const cyberLesson5: AILessonConfig = {
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
        "It's a genuinely new, unrelated password",
        "It's a small, predictable variation of a known-leaked password, which guessing tools can easily try",
        "Numbers are never allowed in passwords",
        "It automatically re-enables MFA",
      ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
        ...
        "MFA is only useful if hashing is disabled",
        "MFA and hashing solve the exact same problem",
      ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
        "Because they are the only security measures that exist",
        ...
        "Because passwords are no longer used at all",
        "Because biometric verification eliminates all risk",
      ],
      correctIndex: 1,
      explanation:
