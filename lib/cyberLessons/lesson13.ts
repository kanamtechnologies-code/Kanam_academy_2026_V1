  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
        ...
        "Assume it's safe because they knew your phone number",
      ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
        ...
        "Reinstalling random software until it works",
      ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
        "Nothing unusual — all extensions need this permission",
        "A possible supply-chain/permission red flag, since the request exceeds the tool's stated purpose",
        "That the extension is automatically safe because it's popular",
        "That permissions never matter for browser extensions",
      ],
      correctIndex: 1,
      explanation:
