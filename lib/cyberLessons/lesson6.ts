...
Today's lesson: **Access Control & Least Privilege**.
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "It can seem like it has nothing to do with least privilege, but that reading skips the distinction this question is testing",
            "It can seem like advisers should have zero access of any kind, but that reading skips the distinction this question is testing",
            "It can seem like advisers are not allowed to use social media, but that reading skips the distinction this question is testing",
          ],
          correctIndex: 0,
          explanation:
...
Role creep feels efficient until something goes wrong. The fix is boring process — which is why it works.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "It can seem like shared admin is best because setup is fastest, but that reading skips the distinction this question is testing",
            "It can seem like all three are equally secure if passwords are long, but that reading skips the distinction this question is testing",
            ...
            "It can seem like only IT professionals may compare these models, but that reading skips the distinction this question is testing",
          ],
      correctIndex: 2,
      explanation:
