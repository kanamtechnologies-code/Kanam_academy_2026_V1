...
export const cyberLesson10: AILessonConfig = {
  ...
  quiz: [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        "Public networks can be less trustworthy. HTTPS, choosing a trustworthy network, and heeding certificate warnings are key defensive habits.",
    },
    {
      id: "q5",
    ...
    },
    {
      ...
      choices: [
        ...
        "Permanently blacklist the site in your head with no follow-up",
      ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
        ...
        "Because padlocks are only shown on mobile devices",
        "Because HTTPS disables all forms",
      ],
      correctIndex: 1,
      explanation:
