...
export const digitalLesson7: AILessonConfig = {
  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        imageAlt: "A post being dragged to a trash can while copies of it — a screenshot, an archive page, and a reshare — float away out of reach",
        callout: {
          label: "Common misconception",
      ...
      },
      {
        ...
        imageAlt: "A four-step footprint clean-up: a magnifying glass searching a name, a privacy-settings slider, a trash can removing old posts, and a star marking a proud project",
        callout: {
          label: "Pro tip",
  ...
  realWorld:
    "Many employers and admissions officers search candidates online before deciding. A clean, positive footprint — including a portfolio of work you're proud of — can be the quiet edge that gets you the offer.",
  quiz: [
    {
      id: "q1",
    ...
    {
      id: "q2",
      question: "Your location, search history, and what you click are part of which footprint?",
      choices: [
        "Active footprint",
        "Passive footprint",
        "No footprint at all",
    ...
    {
      id: "q3",
      question: "You delete an embarrassing post an hour after sending it. Why might it still exist?",
      choices: [
    ...
    {
      id: "q4",
      question: "Which is the best quick test before posting something?",
      choices: [
    ...
    {
      id: "q5",
      question: "What's a smart way to build a POSITIVE digital footprint?",
      choices: [
