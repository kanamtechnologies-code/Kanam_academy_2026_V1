...
export const digitalLesson16: AILessonConfig = {
  ...
  goal: "Pull the whole Digital Literacy track together — review the big areas, self-assess your digital habits, and build a personal 'digital readiness' action plan for school, life, and a future career in tech.",
  xpReward: 800,
  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Let's model exactly what *you'll* do in the reflection. Meet Maya, finishing this track. Watch her turn an honest audit into a tiny, real plan.\n\n**Step 1 — Audit honestly.** Maya checks herself: passwords reused across sites (not-yet), footprint mostly fine (sort-of), healthy habits weak — scrolls in bed every night (not-yet), spreadsheet skills basically none (not-yet).\n\n**Step 2 — Pick the most important gaps.** She can't fix everything at once, so she chooses three that matter most to her: security, sleep, and a work skill.\n\n**Step 3 — Write specific, doable steps.** Not "be safer" — actual actions:`,
        code: `MAYA'S DIGITAL-READINESS PLAN
1. Security:  Set up a password manager + turn on 2FA for email
              and socials.  (This weekend)
2. Wellbeing: Charge phone in the kitchen, not my bedroom, so I
              stop scrolling in bed.  (Starting tonight)
3. Work skill: Learn =SUM() by building a spreadsheet to track
              my money.  (Next week)
...
Mindset: this list is never "done" — I'll keep adding next steps.`,
      ...
      },
      {
        ...
        body: `This is the finish line of the entire Digital Literacy track. You can now navigate technology, judge information, communicate and create, protect yourself, stay healthy, troubleshoot calmly, and bring real skills to a future career — and you understand that true digital literacy is all of that working *together*, for life.\n\nTake the final knowledge check (it pulls from the whole track), then write your own **3-step digital-readiness action plan** in the reflection to earn your 🎓 **Digitally Fluent** badge.\n\nWhen you're ready, switch to the **Knowledge check**. Congratulations — you've become exactly the kind of capable, responsible, lifelong digital learner the real world needs.`,
      },
    ],
  },
  bigIdeas: [
    ...
    "Be a **lifelong digital learner**: audit honestly, then take small, specific next steps in a personal action plan.",
  ],
  keyTerms: [
  ...
  realWorld:
    "The most valuable people in any workplace aren't the ones who know every tool — they're the ones who can learn any tool, stay safe, communicate clearly, and adapt. This capstone is your launchpad for exactly that.",
  quiz: [
    {
      id: "q1",
      question: "Which statement best captures what 'real digital literacy' means?",
      choices: [
    ...
    {
      id: "q2",
      question: "You see a shocking post and feel the urge to share it instantly. The digitally literate move pulls on several skills at once. Which response shows that?",
      choices: [
    ...
    {
      id: "q3",
      question: "What's the point of the self-audit checklist in this capstone?",
      choices: [
    ...
    {
      id: "q4",
      question: "Which is the strongest example of a good action-plan step?",
      choices: [
        "\"Be safer online\"",
        "\"Get better at tech\"",
        "\"Set up a password manager and turn on 2FA for my email this weekend\"",
        "\"Use the internet less, somehow\"",
      ],
      correctIndex: 2,
      explanation:
        "Good plan steps are specific, doable, and have a clear finish. 'Turn on 2FA for my email this weekend' can actually be done; vague goals like 'be safer' can't.",
    },
    {
      id: "q5",
      question: "Why is 'lifelong learning' the key mindset for digital literacy?",
      choices: [
  ...
  reflection: {
    prompt:
      "CAPSTONE: Write your own 3-step digital-readiness action plan. For each step, name the area (e.g. security, footprint, wellbeing, work skills), the specific action you'll take, and when you'll do it.",
    placeholder: "1) Security: set up a password manager + 2FA this weekend. 2) Wellbeing: charge my phone outside my room starting tonight. 3) Work skills: learn =SUM() by building a budget next week…",
  },
};
