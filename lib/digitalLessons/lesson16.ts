    ...
    sections: [
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "It can seem like share immediately so others see it fast, but that reading skips the distinction this question is testing",
            ...
            "It can seem like ignore it because all posts are fake, but that reading skips the distinction this question is testing",
            "It can seem like assume anything dramatic must be real, but that reading skips the distinction this question is testing",
          ],
          correctIndex: 1,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Some learners answer “Only security, since it's asking for information”, yet that does not match the precise idea from the lesson",
            "Several at once — security/privacy, judging information, citizenship (spreading risk to friends), and wellbeing (urgency tricks)",
            "It can seem like only wellbeing, because of the countdown timer, but that reading skips the distinction this question is testing",
            "It can seem like none — it's just a harmless quiz, but that reading skips the distinction this question is testing",
          ],
          correctIndex: 1,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“You failed the track and need to redo it” describes a different situation than the one in the question stem",
            "“Nothing — the audit doesn't matter either way” describes a different situation than the one in the question stem",
            "“You should give up on digital literacy entirely” describes a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“\"Get better at tech\"” describes a different situation than the one in the question stem",
            "“\"Use the internet less, somehow\"” describes a different situation than the one in the question stem",
            "\"Set up a password manager and turn on 2FA for my email and college portal this weekend\"",
            "A rushed pass can land on \"Be safer online\"”; careful readers reject it for this problem",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Because technology never changes” belongs to a different situation than the one in the question stem",
            "Because only experts need to keep learning” belongs to a different situation than the one in the question stem",
            "Because tools, apps, and risks keep changing, so you keep taking new small steps",
            "Because once you finish this track, you're done learning” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 2,
          explanation:
...
Mindset: this list is never "done" — I'll keep adding next steps.`,
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "A common mix-up is to treat being able to code as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "A common mix-up is to treat owning the newest devices as enough, which confuses a nearby idea with the right one when checked against the lesson definition",
            "It can seem like knowing how to stay safe online and nothing else, but that reading skips the distinction this question is testing",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“Only security” describes a different situation than the one in the question stem",
            "None — it's just social media” belongs to a different situation than the one in the question stem",
            "Only information literacy” belongs to a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "“\"Be more organized online\"” describes a different situation than the one in the question stem",
            "“\"Use technology responsibly\"” describes a different situation than the one in the question stem",
            "“\"Try harder with digital stuff\"” describes a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "To compare yourself to classmates” belongs to a different situation than the one in the question stem",
            "To prove you already know everything” belongs to a different situation than the one in the question stem",
            "To get a grade on your digital habits” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "It can seem like only people over 40 need to learn digital literacy, but that reading skips the distinction this question is testing",
            "It's completely true — using apps fluently means you're automatically digitally literate” belongs to a different situation than the one in the question stem",
            ...
            "A common mix-up is to treat digital natives never fall for scams as enough, which confuses a nearby idea with the right one",
          ],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "It can seem like you should never make an action plan, but that reading skips the distinction this question is testing",
            ...
            "Some learners answer “It's not a real trap — waiting has no downside”, yet that does not match the precise idea from the lesson",
            "Some learners answer “Only professionals need to worry about timing”, yet that does not match the precise idea from the lesson",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "Trusting whatever appears at the top of a search or feed” belongs to a different situation than the one in the question stem",
            "Judging whether a source is accurate and useful before you trust or share it",
            "Posting first so your friends can fact-check for you later” belongs to a different situation than the one in the question stem",
            "Designing a logo before reading the assignment” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
