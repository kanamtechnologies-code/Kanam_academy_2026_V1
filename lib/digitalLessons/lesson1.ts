...
**Watch for:** guessing from hype or headlines without using the lesson vocabulary. Push students back to the definitions and examples on the slides.`,
  lessonModule: {
    ...
    sections: [
      ...
      { id: "abstraction", kicker: "Core concept", title: "Abstraction makes complexity usable", body: `An **abstraction** gives you useful control while hiding implementation details. Tapping “submit” on a college application does not require you to route network traffic or write bits to storage.\n\nAn abstraction is a purposeful simplification, not magic. It reveals what a user needs and hides detail until that detail matters.`, checkIn: check("Why is a submit button an abstraction?", ["It replaces hardware", "It lets a user request an action without managing the underlying implementation", "It exposes every server setting", "It eliminates all dependencies"], 1, "The interface simplifies a complex operation; the underlying system still exists and can still fail.") },
  ...
  quiz: [
    { id: "q1", question: "Which comparison is accurate?", choices: [
            "A browser is hardware because it displays a form",
            "An OS is hardware because it starts first",
            "A browser is application software; an OS provides services it uses; a screen is hardware",
            "A screen is system software",
    ...
    { id: "q2", question: "Why is a share button an abstraction?", choices: [
            "It exposes server settings",
            "It guarantees access forever",
            "It replaces the OS",
    ...
    { id: "q3", question: "Why does an OS matter to several applications?", choices: [
            "It gives each app ownership of hardware",
            "It replaces applications",
            "It is only a visual theme",
    ...
    { id: "q4", question: "A team chooses a cloud slide tool. Which tradeoff should they evaluate?", choices: [
            "Whether it removes storage needs",
            "Whether it makes the OS unnecessary",
            "Whether account access and network availability could prevent work at a critical time",
            "Whether it hides the keyboard",
    ...
    { id: "q5", question: "Which device recommendation is most defensible?", choices: [
            "Ignore hardware",
            "Pick only the largest storage number",
            "Assume every device supports every media task",
    ...
    { id: "q7", question: "What is the main benefit of thinking in layers?", choices: [
            ...
            "It guarantees a quick fix",
            "It lets you skip evidence",
            "It proves hardware never fails",
