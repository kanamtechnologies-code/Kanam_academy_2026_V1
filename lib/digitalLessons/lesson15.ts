  ...
  quiz: [
    {
      ...
      choices: [
        "They matter most in tech companies and almost nowhere else",
        "Almost every job now assumes you can use digital tools, so they're a baseline expectation",
        "They replace the need for people skills or trade skills",
        "They're optional extras once you already know the job's core craft",
      ],
      correctIndex: 1,
      explanation:
