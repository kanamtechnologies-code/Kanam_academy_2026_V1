...
export const STRIPE_PRICE = {
  ...
  tracks: {
    ...
    "advanced-ai": "price_1TvMcVDPeYE3b2sPNKv9FYaO",
    "ap-csp-prep": "price_1TvMf6DPeYE3b2sPlO9Qh5V9",
...
export const TRACK_SLUG_BY_PRICE: Record<string, TrackSlug> = {
  ...
  [STRIPE_PRICE.tracks["advanced-ai"]]: "advanced-ai",
  [STRIPE_PRICE.tracks["ap-csp-prep"]]: "ap-csp-prep",
