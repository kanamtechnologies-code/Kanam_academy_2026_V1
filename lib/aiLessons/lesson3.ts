  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Let's trace what happens in the moment between you saying a wake word and your assistant lighting up.\n\n**Step 1 — Capture sound.** The microphone is always sampling the room's sound, turning it into a stream of numbers (the waveform) — thousands of values every second.\n\n**Step 2 — Look for a pattern.** A small AI on the device constantly checks: do these recent numbers match the pattern of the wake word it was trained on? It's not understanding words — it's matching number patterns.\n\n**Step 3 — Decide.** If the pattern matches closely enough, it triggers: "wake word detected!" The assistant wakes up and starts listening for your actual request.\n\n**Step 4 — Why it fails sometimes.** In a loud room, other sounds get added into those numbers, blurring the pattern. The match gets shaky — so it might miss you, or wake up when the TV says something similar.`,
        callout: {
          label: "Pro tip",
      ...
      },
      {
        ...
        body: `Here's what to carry forward: **Perception** means turning real-world signals into numbers a computer can process. **Images** become grids of pixels (red/green/blue numbers), and **sound** becomes a waveform of numbers sampled many times per second. And whenever that input gets messy, perception suffers.\n\nThis one idea — signal → numbers → patterns — quietly powers self-driving cars, photo search, and every voice assistant.\n\nWhen you're ready, switch to the **Knowledge check**, then use what you learned about pixels to explain why face unlock fails in the dark.`,
      },
    ],
  },
  bigIdeas: [
