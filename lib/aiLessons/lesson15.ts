    ...
    sections: [
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“Only robots will have jobs” describes a different situation than the one in the question stem",
            "“AI has no effect on work at all” describes a different situation than the one in the question stem",
            "AI reshapes jobs — automating tasks and creating new roles — rewarding people who work with it",
            "AI will take every job and humans won't work” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Because humans slow the AI down usefully” belongs to a different situation than the one in the question stem",
            "Because two computers are faster than one” belongs to a different situation than the one in the question stem",
            "It doesn't — one is always better” belongs to a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Doing repetitive calculations by hand” belongs to a different situation than the one in the question stem",
            "Memorizing facts you could look up” belongs to a different situation than the one in the question stem",
            "Typing as fast as possible” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
...
Result:     same job, reshaped — human skill matters MORE, not less`,
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "True — AI only affects programmers and engineers” belongs to a different situation than the one in the question stem",
            "“False, but only in wealthy countries” describes a different situation than the one in the question stem",
            "“True, but only for people under 30” describes a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "“AI made radiologists' jobs completely unchanged and irrelevant to learn” describes a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“Memorizing more raw facts, since AI can't look things up” describes a different situation than the one in the question stem",
            "Treat “Neither matters at all for the future of work” as a distractor: close in topic, incorrect for the required answer",
            "Only memorizing facts matters; critical thinking is irrelevant to careers” belongs to a different situation than the one in the question stem",
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "Avoid AI completely to protect my job” belongs to a different situation than the one in the question stem",
            "Let AI make all my decisions” belongs to a different situation than the one in the question stem",
            "Hope AI never improves” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            ...
            "You might defend “Nothing changed about the job at all” in casual talk, but it fails the definition used here",
            "AI became a second set of eyes flagging patterns, while radiologists still diagnosed and took responsibility",
            "You might defend “Hospitals banned AI tools entirely” in casual talk, but it fails the definition used here",
          ],
      correctIndex: 2,
      explanation:
