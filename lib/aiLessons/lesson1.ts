  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Let's walk through what really happens when a photo app sorts your pictures into "cats" and "dogs." Follow the steps and you'll see there's no magic — just pattern-matching.\n\n**Step 1 — Learn from examples.** Before you ever use it, the AI is shown millions of photos already labeled "cat" or "dog" by humans. It slowly tunes itself to notice the visual patterns that go with each label.\n\n**Step 2 — You give it a new photo.** You snap a picture of your friend's kitten. To the AI, this photo is just a giant grid of color numbers (you'll learn exactly how in Lesson 3).\n\n**Step 3 — It matches patterns.** The AI checks: pointy ears? small nose? whisker shapes? It compares your photo's patterns to everything it learned.\n\n**Step 4 — It makes a prediction.** It outputs something like "92% cat, 8% dog." It doesn't *know* it's a cat — it's reporting how strongly the patterns match. The app just shows the top guess: cat.`,
        callout: {
          label: "Pro tip",
