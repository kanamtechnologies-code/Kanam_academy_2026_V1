    ...
    sections: [
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "They take too long to generate” belongs to a different situation than the one in the question stem",
            "They always admit when they're unsure” belongs to a different situation than the one in the question stem",
            "Wrong answers look just as confident and polished as correct ones",
            "They are written in a strange language” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Ask the AI if it's sure, then trust whatever it says” belongs to a different situation than the one in the question stem",
            "Assume they're fake and ignore the whole answer” belongs to a different situation than the one in the question stem",
            "Cite them immediately — they look real” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
...
Verdict: do NOT cite until confirmed by a real source`,
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“No, asking twice always changes the answer” describes a different situation than the one in the question stem",
            "“Yes, but only if it says 'I'm sure'” describes a different situation than the one in the question stem",
            "“Yes — repetition proves accuracy” describes a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "Repost with extra emojis so people know it's informal” belongs to a different situation than the one in the question stem",
            "Ask the same AI if the quote is real and trust its answer” belongs to a different situation than the one in the question stem",
            "Repost it — the scientist probably said something like that” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Assume it's real because it sounds like something they'd say” belongs to a different situation than the one in the question stem",
            "Change a few words so it's technically your own” belongs to a different situation than the one in the question stem",
            "Ask the AI to promise it's accurate” belongs to a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "“She assumed the quote was fake without checking anything” describes a different situation than the one in the question stem",
            "She asked the AI to confirm its own quote and trusted that answer” belongs to a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "Only the word 'social media' needs checking” belongs to a different situation than the one in the question stem",
            "The words 'teens' and 'daily'” belongs to a different situation than the one in the question stem",
            "Nothing needs checking — it sounds official” belongs to a different situation than the one in the question stem",
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "Letting the AI make all final decisions” belongs to a different situation than the one in the question stem",
            "Never using AI at all” belongs to a different situation than the one in the question stem",
            "Only using AI on weekends” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            ...
            "“Yes — repetition proves accuracy” describes a different situation than the one in the question stem",
            "No, because it always changes its answer” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "“Reading two AI answers side by side for style” describes a different situation than the one in the question stem",
            "“A way to make text formatting wider” describes a different situation than the one in the question stem",
            "Reading a page from left to right instead of top to bottom” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "“It only matters if a teacher is watching” describes a different situation than the one in the question stem",
            "Others may trust the claim because you said it, so you become part of spreading possible misinformation",
            "AI claims are always true once repeated by a person” belongs to a different situation than the one in the question stem",
            "It doesn't matter once you've said it, it's not your problem anymore” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "“Only teachers need to worry about digital citizenship, not students” describes a different situation than the one in the question stem",
