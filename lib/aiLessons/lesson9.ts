...
Today's lesson: **How to Talk to AI (Prompting)**.
    ...
    sections: [
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "It doesn't — the AI ignores wording and just guesses” belongs to a different situation than the one in the question stem",
            "Wording only matters if you use capital letters” belongs to a different situation than the one in the question stem",
            "The AI already knows what you meant before you type” belongs to a different situation than the one in the question stem",
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "It changes the AI's role automatically” belongs to a different situation than the one in the question stem",
            "It deletes the context you already gave” belongs to a different situation than the one in the question stem",
            "Nothing — the AI ignores length requests” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
...
in under 80 words total (format + constraint)."`,
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“\"Tell me about dogs.\"” describes a different situation than the one in the question stem",
            "“\"Explain stuff.\"” describes a different situation than the one in the question stem",
            "\"Act as a coach. In 5 bullets, list beginner home workouts for a small apartment.\"",
            "Treat “\"Help.\"” as a distractor: close in topic, incorrect for the required answer",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            "“He asked the AI to lie about being an AI” describes a different situation than the one in the question stem",
            "“He used more exclamation points” describes a different situation than the one in the question stem",
            "He stacked role, task, context, format, and constraints instead of leaving them for the AI to guess",
            "Some learners answer “He typed it faster”, yet that does not match the precise idea from the lesson",
          ],
          correctIndex: 2,
          explanation:
      ...
      },
      {
        ...
        checkIn: {
          ...
          choices: [
            ...
            "\"Act as a friendly coach\"” belongs to a different situation than the one in the question stem",
            "\"suggest warm-up stretches\"” belongs to a different situation than the one in the question stem",
            "\"a 14-year-old before a soccer game\"” belongs to a different situation than the one in the question stem",
          ],
          correctIndex: 0,
          explanation:
  ...
  quiz: [
    {
      ...
      choices: [
            ...
            "It doesn't — the AI ignores your wording” belongs to a different situation than the one in the question stem",
            "The AI only understands one secret password” belongs to a different situation than the one in the question stem",
            "Longer prompts always cost money” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "Picking “Explain savings accounts to me” is a common mix-up that confuses a nearby idea with the right one",
            "It can seem like tell me about money, but that reading skips the distinction this question is testing",
            "Act as a finance coach for teens. In 5 bullets, explain how a savings account works, with one real example.",
            "It can seem like help with saving, but that reading skips the distinction this question is testing",
          ],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "Sets the font of the answer” belongs to a different situation than the one in the question stem",
            "Gives background that narrows the AI toward the answer you actually need",
            "Tells the AI to act as a celebrity” belongs to a different situation than the one in the question stem",
            "Slows the AI down for no reason” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            ...
            "A type of hallucination” belongs to a different situation than the one in the question stem",
            "Another word for the AI's role” belongs to a different situation than the one in the question stem",
            "A secret password that unlocks better answers” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "“It isn't helpful — audience never matters” describes a different situation than the one in the question stem",
            "“It replaces the need for a task entirely” describes a different situation than the one in the question stem",
            "It shapes how the answer sounds and for whom, cutting out extra rounds of 'make it more formal/casual'",
            "“It only matters for coding prompts” describes a different situation than the one in the question stem",
          ],
      correctIndex: 2,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "It's fine as long as the AI promises not to save it” belongs to a different situation than the one in the question stem",
            "No — it's not your information to share, regardless of how useful it would be",
            "Yes, if it makes the AI's answer better” belongs to a different situation than the one in the question stem",
            "Yes, but only if you delete the chat afterward” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
    ...
    },
    {
      ...
      choices: [
            "It doesn't — prompting isn't related to computer science” belongs to a different situation than the one in the question stem",
            "Breaking a fuzzy goal into precise, ordered instructions is a form of decomposition and algorithmic thinking",
            "Only writing actual code counts as computational thinking” belongs to a different situation than the one in the question stem",
            "“Computational thinking only applies to math class” describes a different situation than the one in the question stem",
          ],
      correctIndex: 1,
      explanation:
