  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `**CSTA 2-AP-12**: *Design and iteratively develop programs that combine control structures, including nested loops and compound conditionals.*\n\nThe \`for\` loop is your second major **control structure** (after \`if\`/\`else\`). Combining loops with the conditionals you already know is exactly what this standard is building toward — and you'll do exactly that in the very next lesson.`,
        callout: {
          label: "Standard",
          text: "CSTA 2017, Algorithms & Programming, Level 2: 2-AP-12 — control structures including loops.",
        },
      },
      {
