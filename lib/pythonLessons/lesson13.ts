  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `**CSTA 3A-AP-17**: *Decompose problems into smaller components through systematic analysis, using constructs such as procedures, modules, and/or objects.*\n\nBuilding an NPC means decomposing "make a character that talks" into smaller pieces: a memory dictionary, a response function, and a set of rules — each solving one small part of the larger problem.`,
        callout: {
          label: "Standard",
          text: "CSTA 2017, Algorithms & Programming, Level 3A (grades 9–10): 3A-AP-17 — decompose problems into smaller components.",
        },
      },
      {
