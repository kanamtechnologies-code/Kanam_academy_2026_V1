  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
        ...
        "Store data losslessly",
        "Sort lists efficiently",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "Processors slow down when there are many",
        "Sequential portions and coordination overhead cap the speedup",
        "Parallel computing is always slower",
        "Hardware cannot run software in parallel",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "Runs on one central master computer",
        "Has redundant routing so data can take alternate paths",
        "Uses lossy compression on all data",
        "Sorts packets before sending",
      ],
      correctIndex: 1,
