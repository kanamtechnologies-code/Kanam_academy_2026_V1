  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            ...
            "Only positive numbers above 80” belongs to a different situation than the one in the question stem",
            "59, 60, and 61 (values around the boundary)",
            "Only 90 and 95” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 2,
    ...
    },
    {
      ...
      choices: [
            ...
            "Ship it and wait for more reports” belongs to a different situation than the one in the question stem",
            "Remove all comments” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "# increment i” belongs to a different situation than the one in the question stem",
            "# skip the header row so it isn't counted as data",
            "# variable” belongs to a different situation than the one in the question stem",
            "# loop starts here” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            "It guarantees no logic errors ever occur” belongs to a different situation than the one in the question stem",
            "When something breaks, the recent small change points to the cause",
            "It removes the need for any testing” belongs to a different situation than the one in the question stem",
            "It makes the final file smaller” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            "Crash with an unhandled error” belongs to a different situation than the one in the question stem",
            "Display a clear message or a sensible default instead of crashing",
            "Silently report an average of 100” belongs to a different situation than the one in the question stem",
            "Delete the list” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
