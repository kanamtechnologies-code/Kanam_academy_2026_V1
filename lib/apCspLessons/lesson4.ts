  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            ...
            "It works only on text files” belongs to a different situation than the one in the question stem",
            "It typically achieves much greater size reduction",
            "It never loses any information” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 2,
    ...
    },
    {
      ...
      choices: [
            "The melody a listener hears” belongs to a different situation than the one in the question stem",
            "The audio samples in a song” belongs to a different situation than the one in the question stem",
            "The volume of the recording” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "lossy compression of the responses” belongs to a different situation than the one in the question stem",
            "an overflow error in the counter” belongs to a different situation than the one in the question stem",
            "roundoff error” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "The data is corrupted” belongs to a different situation than the one in the question stem",
            "They are correlated, but this alone does not prove causation",
            "One variable must be metadata” belongs to a different situation than the one in the question stem",
            "One definitely causes the other” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            ...
            "It causes overflow errors” belongs to a different situation than the one in the question stem",
            "“It removes all metadata” describes a different situation than the one in the question stem",
            "It always uses lossy compression” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
    ...
    },
    {
      ...
      choices: [
            "Compress it losslessly” belongs to a different situation than the one in the question stem",
            "Assume the results will be accurate anyway” belongs to a different situation than the one in the question stem",
            "Add more metadata” belongs to a different situation than the one in the question stem",
