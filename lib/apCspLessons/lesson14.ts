...
Today's lesson: **Legal & Ethical Computing: IP, Privacy & Security**.

**Goal:** Apply the rules of intellectual property, licensing, privacy, and security to real computing decisions.

**How to facilitate**
1. Warm-up: ask students what they already think about "The rules that govern computing".
  ...
  quiz: [
    {
      ...
      choices: [
            ...
            "It's free to copy since it's public",
            "You can use it if you change one line",
            "Copyright never applies to code",
          ],
      correctIndex: 0,
    ...
    },
    {
      ...
      choices: [
            "It is always free of any obligations",
    ...
    },
    {
      ...
      choices: [
            "One shared secret key is used by everyone",
            "No keys are used",
            "Data is compressed, not encrypted",
