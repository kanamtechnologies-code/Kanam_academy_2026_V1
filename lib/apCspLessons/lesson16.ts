...
Today's lesson: **AP-Style Practice Gauntlet & Exam Readiness**.

**Goal:** Consolidate all five Big Ideas, practice mixed AP-style questions (including RANDOM and Create PT prompts), and build a confident exam-day strategy.

**How to facilitate**
1. Warm-up: ask students what they already think about "Everything, at once".
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            ...
            "Ignores who is affected",
            "Says it is purely bad",
            "Says the innovation is purely good",
          ],
      correctIndex: 0,
    ...
    },
    {
      ...
      choices: [
            "Is as short as possible with no parameters",
            "Only displays a fixed message",
            "Avoids using any list",
