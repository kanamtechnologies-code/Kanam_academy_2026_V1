...
Today's lesson: **Conditionals & Boolean Logic**.

**Goal:** Control program flow with selection, and evaluate Boolean expressions using AND, OR, NOT and truth tables.

**How to facilitate**
1. Warm-up: ask students what they already think about "Making programs decide".
...
Next you'll add repetition — iteration and loops — so a program can do work many times without you writing it many times.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "It uses MOD incorrectly” belongs to a different situation than the one in the question stem",
            "The order is wrong — 95 matches x≥70 first and gets 'C'",
            "It has too many branches” belongs to a different situation than the one in the question stem",
            "ELSE IF is not valid” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            "Because OR would be faster” belongs to a different situation than the one in the question stem",
            "To make the code shorter” belongs to a different situation than the one in the question stem",
            "Because MOD requires it” belongs to a different situation than the one in the question stem",
