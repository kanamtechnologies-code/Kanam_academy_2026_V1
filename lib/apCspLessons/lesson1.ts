...
You now have the vocabulary the AP exam uses to reason about how programs come to exist. In the next lesson you'll formalize the development process itself — testing strategies, documentation, and handling errors.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
        "Writing the entire program once, then never changing it",
        "Building small pieces and repeatedly testing and revising based on feedback",
        "Designing on paper without ever building a prototype",
        "Adding as many features as possible before release",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "The app should be really good and fun",
        "The user can select a subject from the list of offered subjects",
        "The app should use the newest colors",
        "Make the program impressive to judges",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "To finalize the color scheme before anything else",
        "To gather feedback on a specific question before investing in full development",
        "To guarantee the final program has no errors",
        "To avoid ever having to talk to users",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
        "To make the program run without inputs",
        "To track changes and authorship and recover earlier working versions",
        "To hide who contributed to the project",
        "To replace the program's documentation entirely",
      ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
        ...
        "A preference for finishing all design before testing",
      ],
      correctIndex: 1,
