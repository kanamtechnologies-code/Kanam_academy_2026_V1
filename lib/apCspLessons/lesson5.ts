...
Next you'll use these Boolean values to make decisions with conditionals and Boolean logic — the gateway to programs that behave differently for different inputs.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "Do a ← b then b ← a” belongs to a different situation than the one in the question stem",
            "Use a temporary variable to hold one value before overwriting",
            "It is impossible to swap two variables” belongs to a different situation than the one in the question stem",
            "Add a and b together” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            ...
            "Create a new constant” belongs to a different situation than the one in the question stem",
            "Compare x to x + 1” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "Because strings cannot contain spaces” belongs to a different situation than the one in the question stem",
            ...
            "Because MOD removed the space” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 2,
