  ...
  quiz: [
    {
      ...
      choices: [
            "List only its benefits” belongs to a different situation than the one in the question stem",
            "Assume all effects were intended” belongs to a different situation than the one in the question stem",
            "Focus only on its hardware” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "Too much bandwidth” belongs to a different situation than the one in the question stem",
            "Using HTTPS” belongs to a different situation than the one in the question stem",
            "Biased or unrepresentative training data/design",
            "Malicious developers” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 2,
    ...
    },
    {
      ...
      choices: [
            "It only affects bandwidth” belongs to a different situation than the one in the question stem",
            "It can improve public health but risks surveillance, so safeguards matter",
            "It has no privacy implications” belongs to a different situation than the one in the question stem",
            "It is always harmful” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            "Make it run faster” belongs to a different situation than the one in the question stem",
            "Compress its data” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "Only its programming language” belongs to a different situation than the one in the question stem",
            "Only the innovation's name” belongs to a different situation than the one in the question stem",
            "Only its price” belongs to a different situation than the one in the question stem",
