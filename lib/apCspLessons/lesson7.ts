...
Today's lesson: **Iteration & Loops**.

**Goal:** Use definite and conditional loops correctly, trace iterations, and avoid off-by-one and infinite-loop bugs.

**How to facilitate**
1. Warm-up: ask students what they already think about "Do it many times without writing it many times".
...
Next you'll pair loops with **lists**, the collections you'll traverse to build almost any data-driven program.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "Because counters must be strings” belongs to a different situation than the one in the question stem",
            "So it isn't reset to its starting value every iteration",
            "To create an infinite loop” belongs to a different situation than the one in the question stem",
            "To make the loop run faster” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            "REPEAT 1 TIMES” belongs to a different situation than the one in the question stem",
            "FOR EACH item IN list” belongs to a different situation than the one in the question stem",
            "REPEAT 10 TIMES” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "To avoid a syntax error” belongs to a different situation than the one in the question stem",
            "It runs faster” belongs to a different situation than the one in the question stem",
            "Because 0 is not a number” belongs to a different situation than the one in the question stem",
