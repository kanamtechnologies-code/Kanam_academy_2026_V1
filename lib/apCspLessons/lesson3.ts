...
Today's lesson: **Bits, Binary & Data Abstraction**.

**Goal:** Explain how computers represent all data with bits, convert binary and decimal, and reason about abstraction.

**How to facilitate**
1. Warm-up: ask students what they already think about "Everything is bits".
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            ...
            "Because the program has a syntax error",
            "Because binary cannot represent any fractions",
