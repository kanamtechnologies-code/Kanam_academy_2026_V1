...
Today's lesson: **Create Performance Task Studio**.

**Goal:** Plan a Create Performance Task program that meets every scoring requirement, then draft written responses that earn the points.

**How to facilitate**
1. Warm-up: ask students what they already think about "The task that ties it all together".
  ...
  quiz: [
    {
      ...
      choices: [
            "A 3D graphics engine” belongs to a different situation than the one in the question stem",
            "At least 1,000 lines of code” belongs to a different situation than the one in the question stem",
            "Use of a specific paid library” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "Contain only numbers” belongs to a different situation than the one in the question stem",
            "Be exactly 10 elements long” belongs to a different situation than the one in the question stem",
            "Be used to manage complexity (the program is better with it than without)",
            "Never be traversed” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 2,
    ...
    },
    {
      ...
      choices: [
            ...
            "Only a print statement” belongs to a different situation than the one in the question stem",
            "Exactly one line” belongs to a different situation than the one in the question stem",
            "No parameters” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
    ...
    },
    {
      ...
      choices: [
            "Add more comments only” belongs to a different situation than the one in the question stem",
            "Describe two calls with different arguments and their different results",
            "State that parameters are important in general” belongs to a different situation than the one in the question stem",
            "Make the parameter unused” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            ...
            "Explaining their own code too specifically” belongs to a different situation than the one in the question stem",
            "Acknowledging their sources” belongs to a different situation than the one in the question stem",
            "Using a list to manage complexity” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
    ...
    },
    {
      ...
      choices: [
            "Hide that you reused it” belongs to a different situation than the one in the question stem",
            "Only credit paid content” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "It is the official AP course and grants college credit automatically” belongs to a different situation than the one in the question stem",
            "It prepares you for the exam and Create PT; you still register and submit through College Board",
            "A rushed pass can land on it replaces the AP exam”; careful readers reject it for this problem",
            "It submits your Create PT to the Digital Portfolio for you” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
