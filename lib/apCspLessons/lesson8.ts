...
Today's lesson: **Lists & Traversal**.

**Goal:** Store collections in lists, access and modify elements by index, and traverse lists to compute results.

**How to facilitate**
1. Warm-up: ask students what they already think about "One name for many values".
...
Lists + loops + conditionals is enough to build the data engine of most Create PT programs. Next you'll package logic into reusable **procedures** with parameters — the heart of abstraction in code.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "No loop is needed” belongs to a different situation than the one in the question stem",
            "FOR EACH element” belongs to a different situation than the one in the question stem",
            "Index-based traversal (FOR i FROM 1 TO LENGTH)",
            "A conditional only” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 2,
    ...
    },
    {
      ...
      choices: [
            "is not allowed in pseudocode” belongs to a different situation than the one in the question stem",
            "causes an overflow” belongs to a different situation than the one in the question stem",
            "is always slower” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "Always finds the value in one step” belongs to a different situation than the one in the question stem",
            "Requires the list to be sorted” belongs to a different situation than the one in the question stem",
            "Only works on numbers” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            "To make the loop faster” belongs to a different situation than the one in the question stem",
            "To avoid dividing by zero when no scores pass",
            "To sort the results” belongs to a different situation than the one in the question stem",
            "Because count must be a string” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
