  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            ...
            "prints text in color” belongs to a different situation than the one in the question stem",
            "can only appear in loops” belongs to a different situation than the one in the question stem",
            "creates a new list” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 0,
    ...
    },
    {
      ...
      choices: [
            "Because parameters are required by the language” belongs to a different situation than the one in the question stem",
            "To demonstrate genuine procedural abstraction where input changes the result",
            "“To avoid using lists” describes a different situation than the one in the question stem",
            "To make the program longer” belongs to a different situation than the one in the question stem",
          ],
      correctIndex: 1,
    ...
    },
    {
      ...
      choices: [
            "Rewrite it yourself” belongs to a different situation than the one in the question stem",
            "Read its full source code first” belongs to a different situation than the one in the question stem",
            "Convert it to a loop” belongs to a different situation than the one in the question stem",
    ...
    },
    {
      ...
      choices: [
            ...
            "It guarantees zero bugs” belongs to a different situation than the one in the question stem",
            "It makes the program use more memory” belongs to a different situation than the one in the question stem",
