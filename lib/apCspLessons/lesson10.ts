...
Today's lesson: **Algorithms, Efficiency & Searching/Sorting**.

**Goal:** Compare algorithms for correctness and efficiency, and reason about searching, sorting, and undecidable problems.

**How to facilitate**
1. Warm-up: ask students what they already think about "Many algorithms, not all equal".
...
This completes the core of Big Idea 3. Next you'll zoom out to the machines and networks that run these algorithms — computing systems and the Internet.`,
  ...
  quiz: [
    ...
    },
    {
      ...
      choices: [
            "Declare the problem undecidable",
    ...
    },
    {
      ...
      choices: [
            "Takes exponential time but is solvable",
            "Only occurs in networks",
    ...
    },
    {
      ...
      choices: [
            "The simulation guarantees exactly what the weather will do",
            "Running it once tests every possible outcome",
            "Simulations cannot use randomness",
