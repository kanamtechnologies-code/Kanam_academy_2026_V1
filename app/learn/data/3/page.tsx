    ...
    sections: [
      {
        ...
        body: `Choosing the right columns — in the right order — is how analysts turn a messy table into a clear answer.\n\nToday you'll also learn \`DISTINCT\`, which removes duplicate rows so you can see the **unique** values in a column.`,
        ...
        callout: {
          ...
          text: "A \"list of unique countries our customers come from\" or \"the different products we sell\" both rely on DISTINCT to remove repeats.",
        },
      },
      {
        id: "order",
        ...
        body: `The order you list columns in \`SELECT\` is the order they appear in the result. Swap them around to put the most important column first.`,
      ...
      },
      {
        ...
        body: `Two students both ordered "Pizza slice" and "Salad". \`SELECT DISTINCT item\` collapses those repeats so each item appears **only once** — a list of what's on the menu.`,
      ...
      },
      {
        ...
        body: `In the exercises you'll pick columns, reorder them, and use \`DISTINCT\` to find the unique values.\n\nClick **Start the exercises** when you're ready.`,
      },
    ],
  },
