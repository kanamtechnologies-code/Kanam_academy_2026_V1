  ...
  lessonModule: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Combining tools into one investigation is the heart of computational thinking.`,
        bullets: [
          "**CSTA 3A-DA-12** — Create computational models that represent data by combining and transforming data from multiple sources.",
          "**CSTA 3B-DA-07** — Evaluate the ability of a model to illuminate a real-world problem, exactly what a JOIN + GROUP BY + ORDER BY pipeline does.",
          "**ISTE Computational Thinker** — Breaking a big, fuzzy question into a sequence of smaller, solvable steps.",
        ],
      },
      {
        id: "reflection",
