# Facilitator guide — Digital Literacy · Week 7 · Session 2

**Lesson id:** `dl-14` · **URL:** `/learn/digital/14`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `digital-literacy` / `dl-14` |
| **Title** | Systematic Troubleshooting Others Can Reuse |
| **Time** | 40–55 min |
| **Week theme** | Agency: Wellbeing & Troubleshooting |
| **Student goal** | Complete **Systematic Troubleshooting Others Can Reuse** and demonstrate the week focus: Personal impacts of computing, plus systematic troubleshooting guidelines others can reuse. |
| **Standards** | CSTA 3A CS / NI / IC / DA |
| **Materials** | Browser devices · projector · scenario discussion |
| **XP / badge** | 700 · Troubleshoot Designer |
...
- [ ] Open `/learn/digital/14` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Personal impacts of computing, plus systematic troubleshooting guidelines others can reuse.* | Follow Lesson tab |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w7-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w7-s2-tabs.png` |
| C | Help / Coach guidance open | `dl-w7-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w7-s2-editor.png` |
| E | Success / check state | `dl-w7-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w7-s2-console.png` |

![Hero placeholder](../../images/dl-w7-s2-hero.png)

**Capture checklist:** local unlock → `/learn/digital/14` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
