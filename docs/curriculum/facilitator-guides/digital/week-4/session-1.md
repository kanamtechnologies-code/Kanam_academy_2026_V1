# Facilitator guide — Digital Literacy · Week 4 · Session 1

**Lesson id:** `dl-7` · **URL:** `/learn/digital/7`
...
- [ ] Open `/learn/digital/7` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Reputation and footprint — then evaluate computing’s cultural impacts and equity deficits.* | Follow Lesson tab |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w4-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w4-s1-tabs.png` |
| C | Help / Coach guidance open | `dl-w4-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w4-s1-editor.png` |
| E | Success / check state | `dl-w4-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w4-s1-console.png` |

![Hero placeholder](../../images/dl-w4-s1-hero.png)

**Capture checklist:** local unlock → `/learn/digital/7` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
