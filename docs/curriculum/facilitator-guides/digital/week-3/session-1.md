# Facilitator guide — Digital Literacy · Week 3 · Session 1

**Lesson id:** `dl-5` · **URL:** `/learn/digital/5`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `digital-literacy` / `dl-5` |
| **Title** | Messages That Get Answered |
| **Time** | 40–55 min |
| **Week theme** | Messages and Teamwork |
| **Student goal** | Complete **Messages That Get Answered** and demonstrate the week focus: Professional digital communication and collaboration across teams, cultures, and careers. |
| **Standards** | CSTA 3A CS / NI / IC / DA |
| **Materials** | Browser devices · projector · scenario discussion |
| **XP / badge** | 250 · Pro Communicator |
...
- [ ] Open `/learn/digital/5` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Professional digital communication and collaboration across teams, cultures, and careers.* | Follow Lesson tab |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w3-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w3-s1-tabs.png` |
| C | Help / Coach guidance open | `dl-w3-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w3-s1-editor.png` |
| E | Success / check state | `dl-w3-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w3-s1-console.png` |

![Hero placeholder](../../images/dl-w3-s1-hero.png)

**Capture checklist:** local unlock → `/learn/digital/5` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
