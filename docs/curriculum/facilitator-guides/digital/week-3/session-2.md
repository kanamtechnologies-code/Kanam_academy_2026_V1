# Facilitator guide — Digital Literacy · Week 3 · Session 2

**Lesson id:** `dl-6` · **URL:** `/learn/digital/6`
...
- [ ] Open `/learn/digital/6` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w3-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w3-s2-tabs.png` |
| C | Help / Coach guidance open | `dl-w3-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w3-s2-editor.png` |
| E | Success / check state | `dl-w3-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w3-s2-console.png` |

![Hero placeholder](../../images/dl-w3-s2-hero.png)

**Capture checklist:** local unlock → `/learn/digital/6` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
