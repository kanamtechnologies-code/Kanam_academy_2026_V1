# Facilitator guide — Digital Literacy · Week 8 · Session 2

**Lesson id:** `dl-16` · **URL:** `/learn/digital/16`
...
- [ ] Open `/learn/digital/16` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Connected workplaces and careers — then evaluate impacts and ship a personal action plan.* | Follow Lesson tab |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w8-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w8-s2-tabs.png` |
| C | Help / Coach guidance open | `dl-w8-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w8-s2-editor.png` |
| E | Success / check state | `dl-w8-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w8-s2-console.png` |

![Hero placeholder](../../images/dl-w8-s2-hero.png)

**Capture checklist:** local unlock → `/learn/digital/16` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
