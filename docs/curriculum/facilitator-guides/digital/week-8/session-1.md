# Facilitator guide — Digital Literacy · Week 8 · Session 1

**Lesson id:** `dl-15` · **URL:** `/learn/digital/15`
...
- [ ] Open `/learn/digital/15` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w8-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w8-s1-tabs.png` |
| C | Help / Coach guidance open | `dl-w8-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w8-s1-editor.png` |
| E | Success / check state | `dl-w8-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w8-s1-console.png` |

![Hero placeholder](../../images/dl-w8-s1-hero.png)

**Capture checklist:** local unlock → `/learn/digital/15` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
