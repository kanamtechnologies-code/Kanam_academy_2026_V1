# Facilitator guide — Digital Literacy · Week 6 · Session 2

**Lesson id:** `dl-12` · **URL:** `/learn/digital/12`
...
- [ ] Open `/learn/digital/12` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Everyday threats, recommend controls, and evaluate automated data collection and privacy ethics.* | Follow Lesson tab |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w6-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w6-s2-tabs.png` |
| C | Help / Coach guidance open | `dl-w6-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w6-s2-editor.png` |
| E | Success / check state | `dl-w6-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w6-s2-console.png` |

![Hero placeholder](../../images/dl-w6-s2-hero.png)

**Capture checklist:** local unlock → `/learn/digital/12` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
