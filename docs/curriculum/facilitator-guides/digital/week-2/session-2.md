# Facilitator guide — Digital Literacy · Week 2 · Session 2

**Lesson id:** `dl-4` · **URL:** `/learn/digital/4`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `digital-literacy` / `dl-4` |
| **Title** | Evaluating Claims in a Computing Culture |
| **Time** | 40–55 min |
| **Week theme** | Networks & Information Integrity |
| **Student goal** | Complete **Evaluating Claims in a Computing Culture** and demonstrate the week focus: How networks move data, search fluently, and evaluate claims in a computing culture. |
| **Standards** | CSTA 3A CS / NI / IC / DA |
| **Materials** | Browser devices · projector · scenario discussion |
| **XP / badge** | 200 · Critical Evaluator |
...
- [ ] Open `/learn/digital/4` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *How networks move data, search fluently, and evaluate claims in a computing culture.* | Follow Lesson tab |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w2-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w2-s2-tabs.png` |
| C | Help / Coach guidance open | `dl-w2-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w2-s2-editor.png` |
| E | Success / check state | `dl-w2-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w2-s2-console.png` |

![Hero placeholder](../../images/dl-w2-s2-hero.png)

**Capture checklist:** local unlock → `/learn/digital/4` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
