# Facilitator guide — Digital Literacy · Week 1 · Session 2

**Lesson id:** `dl-2` · **URL:** `/learn/digital/2`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `digital-literacy` / `dl-2` |
| **Title** | Where Your Files Live |
| **Time** | 40–55 min |
| **Week theme** | Hardware, Software & Your Files |
| **Student goal** | Complete **Where Your Files Live** and pick a home for a real file: on the device, in the cloud, or both — plus a backup. |
| **Standards** | CSTA 3A CS / NI / IC / DA |
| **Materials** | Browser devices · projector · scenario discussion |
| **XP / badge** | 100 · Storage Strategist |
...
- [ ] Open `/learn/digital/2` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides. Stay on on-device vs cloud, naming, sharing, and a real backup. | Follow Lesson tab |
...
Week theme: **Hardware, Software & Your Files**.  
Focus: on the device vs in the cloud, naming, sharing, and a real backup.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `dl-w1-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `dl-w1-s2-tabs.png` |
| C | Help / Coach guidance open | `dl-w1-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `dl-w1-s2-editor.png` |
| E | Success / check state | `dl-w1-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `dl-w1-s2-console.png` |

![Hero placeholder](../../images/dl-w1-s2-hero.png)

**Capture checklist:** local unlock → `/learn/digital/2` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
