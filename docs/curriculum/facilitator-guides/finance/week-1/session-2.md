# Facilitator guide — Financial Literacy · Week 1 · Session 2

**Lesson id:** `fl-2` · **URL:** `/learn/finance/2`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-2` |
| **Title** | Needs, Wants & Tradeoffs |
| **Time** | 40–55 min |
| **Week theme** | Money Foundations |
| **Student goal** | Complete **Needs, Wants & Tradeoffs** and demonstrate the week focus: What money is for, goals, values, and smart needs-vs-wants decisions. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 100 · Tradeoff Thinker |
...
- [ ] Open `/learn/finance/2` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *What money is for, goals, values, and smart needs-vs-wants decisions.* | Follow Lesson tab |
...
Week theme: **Money Foundations**.  
Focus: What money is for, goals, values, and smart needs-vs-wants decisions.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w1-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w1-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w1-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w1-s2-editor.png` |
| E | Success / check state | `fl-w1-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w1-s2-console.png` |

![Hero placeholder](../../images/fl-w1-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/2` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
