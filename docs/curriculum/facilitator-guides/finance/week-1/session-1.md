# Facilitator guide — Financial Literacy · Week 1 · Session 1

**Lesson id:** `fl-1` · **URL:** `/learn/finance/1`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-1` |
| **Title** | Money, Goals & You |
| **Time** | 40–55 min |
| **Week theme** | Money Foundations |
| **Student goal** | Complete **Money, Goals & You** and demonstrate the week focus: What money is for, goals, values, and smart needs-vs-wants decisions. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 50 · Money Starter |
...
- [ ] Open `/learn/finance/1` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w1-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w1-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w1-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w1-s1-editor.png` |
| E | Success / check state | `fl-w1-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w1-s1-console.png` |

![Hero placeholder](../../images/fl-w1-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
