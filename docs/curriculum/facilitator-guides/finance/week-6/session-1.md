# Facilitator guide — Financial Literacy · Week 6 · Session 1

**Lesson id:** `fl-11` · **URL:** `/learn/finance/11`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-11` |
| **Title** | Insurance: Protecting What Matters |
| **Time** | 40–55 min |
| **Week theme** | Protection & Consumer Power |
| **Student goal** | Complete **Insurance: Protecting What Matters** and demonstrate the week focus: Insurance basics, then scams, fraud, and consumer rights. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 550 · Coverage Checker |
...
- [ ] Open `/learn/finance/11` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Insurance basics, then scams, fraud, and consumer rights.* | Follow Lesson tab |
...
Week theme: **Protection & Consumer Power**.  
Focus: Insurance basics, then scams, fraud, and consumer rights.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w6-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w6-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w6-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w6-s1-editor.png` |
| E | Success / check state | `fl-w6-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w6-s1-console.png` |

![Hero placeholder](../../images/fl-w6-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/11` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
