# Facilitator guide — Financial Literacy · Week 6 · Session 2

**Lesson id:** `fl-12` · **URL:** `/learn/finance/12`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-12` |
| **Title** | Scams, Fraud & Consumer Rights |
| **Time** | 40–55 min |
| **Week theme** | Protection & Consumer Power |
| **Student goal** | Complete **Scams, Fraud & Consumer Rights** and demonstrate the week focus: Insurance basics, then scams, fraud, and consumer rights. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 600 · Consumer Guardian |
...
- [ ] Open `/learn/finance/12` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w6-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w6-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w6-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w6-s2-editor.png` |
| E | Success / check state | `fl-w6-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w6-s2-console.png` |

![Hero placeholder](../../images/fl-w6-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/12` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
