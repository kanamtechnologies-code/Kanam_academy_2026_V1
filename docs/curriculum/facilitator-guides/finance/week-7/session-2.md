# Facilitator guide — Financial Literacy · Week 7 · Session 2

**Lesson id:** `fl-14` · **URL:** `/learn/finance/14`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-14` |
| **Title** | College Costs, Aid & Loans |
| **Time** | 40–55 min |
| **Week theme** | Taxes, Jobs & Big Costs |
| **Student goal** | Complete **College Costs, Aid & Loans** and demonstrate the week focus: First-job taxes and pay stubs, then college costs, aid, and student loan awareness. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 700 · Aid Navigator |
...
- [ ] Open `/learn/finance/14` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *First-job taxes and pay stubs, then college costs, aid, and student loan awareness.* | Follow Lesson tab |
...
Week theme: **Taxes, Jobs & Big Costs**.  
Focus: First-job taxes and pay stubs, then college costs, aid, and student loan awareness.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w7-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w7-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w7-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w7-s2-editor.png` |
| E | Success / check state | `fl-w7-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w7-s2-console.png` |

![Hero placeholder](../../images/fl-w7-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/14` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
