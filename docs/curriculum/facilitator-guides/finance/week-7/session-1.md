# Facilitator guide — Financial Literacy · Week 7 · Session 1

**Lesson id:** `fl-13` · **URL:** `/learn/finance/13`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-13` |
| **Title** | Taxes & Your First Job |
| **Time** | 40–55 min |
| **Week theme** | Taxes, Jobs & Big Costs |
| **Student goal** | Complete **Taxes & Your First Job** and demonstrate the week focus: First-job taxes and pay stubs, then college costs, aid, and student loan awareness. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 650 · Tax Rookie |
...
- [ ] Open `/learn/finance/13` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w7-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w7-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w7-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w7-s1-editor.png` |
| E | Success / check state | `fl-w7-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w7-s1-console.png` |

![Hero placeholder](../../images/fl-w7-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/13` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
