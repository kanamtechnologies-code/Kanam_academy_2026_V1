# Facilitator guide — Financial Literacy · Week 2 · Session 2

**Lesson id:** `fl-4` · **URL:** `/learn/finance/4`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-4` |
| **Title** | Banks, Accounts & Cards |
| **Time** | 40–55 min |
| **Week theme** | Earning & Banking |
| **Student goal** | Complete **Banks, Accounts & Cards** and demonstrate the week focus: Paychecks and taxes basics, then checking, savings, and debit vs credit cards. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 200 · Banking Basics |
...
- [ ] Open `/learn/finance/4` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Paychecks and taxes basics, then checking, savings, and debit vs credit cards.* | Follow Lesson tab |
...
Week theme: **Earning & Banking**.  
Focus: Paychecks and taxes basics, then checking, savings, and debit vs credit cards.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w2-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w2-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w2-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w2-s2-editor.png` |
| E | Success / check state | `fl-w2-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w2-s2-console.png` |

![Hero placeholder](../../images/fl-w2-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/4` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
