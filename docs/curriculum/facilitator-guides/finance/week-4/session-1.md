# Facilitator guide — Financial Literacy · Week 4 · Session 1

**Lesson id:** `fl-7` · **URL:** `/learn/finance/7`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-7` |
| **Title** | Credit Scores & Reports |
| **Time** | 40–55 min |
| **Week theme** | Credit & Debt |
| **Student goal** | Complete **Credit Scores & Reports** and demonstrate the week focus: Credit scores and reports, then interest, loans, and avoiding debt traps. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 350 · Credit Reader |
...
- [ ] Open `/learn/finance/7` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w4-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w4-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w4-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w4-s1-editor.png` |
| E | Success / check state | `fl-w4-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w4-s1-console.png` |

![Hero placeholder](../../images/fl-w4-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/7` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
