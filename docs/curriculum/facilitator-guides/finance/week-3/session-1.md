# Facilitator guide — Financial Literacy · Week 3 · Session 1

**Lesson id:** `fl-5` · **URL:** `/learn/finance/5`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-5` |
| **Title** | Build a Budget That Works |
| **Time** | 40–55 min |
| **Week theme** | Budgeting & Cash Flow |
| **Student goal** | Complete **Build a Budget That Works** and demonstrate the week focus: Build a real budget, track spending, and start an emergency fund. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 250 · Budget Builder |
...
- [ ] Open `/learn/finance/5` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w3-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w3-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w3-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w3-s1-editor.png` |
| E | Success / check state | `fl-w3-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w3-s1-console.png` |

![Hero placeholder](../../images/fl-w3-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/5` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
