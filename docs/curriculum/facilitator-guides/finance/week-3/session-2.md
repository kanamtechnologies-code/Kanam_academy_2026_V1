# Facilitator guide — Financial Literacy · Week 3 · Session 2

**Lesson id:** `fl-6` · **URL:** `/learn/finance/6`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-6` |
| **Title** | Spending Tracking & Emergency Funds |
| **Time** | 40–55 min |
| **Week theme** | Budgeting & Cash Flow |
| **Student goal** | Complete **Spending Tracking & Emergency Funds** and demonstrate the week focus: Build a real budget, track spending, and start an emergency fund. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 300 · Cash Flow Keeper |
...
- [ ] Open `/learn/finance/6` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Build a real budget, track spending, and start an emergency fund.* | Follow Lesson tab |
...
Week theme: **Budgeting & Cash Flow**.  
Focus: Build a real budget, track spending, and start an emergency fund.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w3-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w3-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w3-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w3-s2-editor.png` |
| E | Success / check state | `fl-w3-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w3-s2-console.png` |

![Hero placeholder](../../images/fl-w3-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/6` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
