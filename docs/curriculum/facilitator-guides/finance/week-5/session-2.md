# Facilitator guide — Financial Literacy · Week 5 · Session 2

**Lesson id:** `fl-10` · **URL:** `/learn/finance/10`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-10` |
| **Title** | Investing Basics & Risk |
| **Time** | 40–55 min |
| **Week theme** | Saving & Investing |
| **Student goal** | Complete **Investing Basics & Risk** and demonstrate the week focus: Compound growth, saving strategies, and investing basics with risk in mind. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 500 · Investor Apprentice |
...
- [ ] Open `/learn/finance/10` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Compound growth, saving strategies, and investing basics with risk in mind.* | Follow Lesson tab |
...
Week theme: **Saving & Investing**.  
Focus: Compound growth, saving strategies, and investing basics with risk in mind.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w5-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w5-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w5-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w5-s2-editor.png` |
| E | Success / check state | `fl-w5-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w5-s2-console.png` |

![Hero placeholder](../../images/fl-w5-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/10` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
