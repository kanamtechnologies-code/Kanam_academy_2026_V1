# Facilitator guide — Financial Literacy · Week 5 · Session 1

**Lesson id:** `fl-9` · **URL:** `/learn/finance/9`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-9` |
| **Title** | Saving & Compound Growth |
| **Time** | 40–55 min |
| **Week theme** | Saving & Investing |
| **Student goal** | Complete **Saving & Compound Growth** and demonstrate the week focus: Compound growth, saving strategies, and investing basics with risk in mind. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 450 · Growth Saver |
...
- [ ] Open `/learn/finance/9` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w5-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w5-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w5-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w5-s1-editor.png` |
| E | Success / check state | `fl-w5-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w5-s1-console.png` |

![Hero placeholder](../../images/fl-w5-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/9` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
