# Facilitator guide — Financial Literacy · Week 8 · Session 2

**Lesson id:** `fl-16` · **URL:** `/learn/finance/16`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-16` |
| **Title** | Capstone: Your First-Year Money Plan |
| **Time** | 40–55 min |
| **Week theme** | Plan & Capstone |
| **Student goal** | Complete **Capstone: Your First-Year Money Plan** and demonstrate the week focus: Big money tradeoffs, then ship your First-Year Money Plan. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 800 · Money Planner |
...
- [ ] Open `/learn/finance/16` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Big money tradeoffs, then ship your First-Year Money Plan.* | Follow Lesson tab |
...
Week theme: **Plan & Capstone**.  
Focus: Big money tradeoffs, then ship your First-Year Money Plan.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w8-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w8-s2-tabs.png` |
| C | Help / Coach guidance open | `fl-w8-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w8-s2-editor.png` |
| E | Success / check state | `fl-w8-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w8-s2-console.png` |

![Hero placeholder](../../images/fl-w8-s2-hero.png)

**Capture checklist:** local unlock → `/learn/finance/16` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
