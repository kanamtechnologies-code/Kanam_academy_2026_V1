# Facilitator guide — Financial Literacy · Week 8 · Session 1

**Lesson id:** `fl-15` · **URL:** `/learn/finance/15`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `financial-literacy` / `fl-15` |
| **Title** | Big Money Decisions |
| **Time** | 40–55 min |
| **Week theme** | Plan & Capstone |
| **Student goal** | Complete **Big Money Decisions** and demonstrate the week focus: Big money tradeoffs, then ship your First-Year Money Plan. |
| **Standards** | Jump$tart / CEE 2021 |
| **Materials** | Browser devices · projector · age-appropriate money examples |
| **XP / badge** | 750 · Decision Pro |
...
- [ ] Open `/learn/finance/15` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `fl-w8-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `fl-w8-s1-tabs.png` |
| C | Help / Coach guidance open | `fl-w8-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `fl-w8-s1-editor.png` |
| E | Success / check state | `fl-w8-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `fl-w8-s1-console.png` |

![Hero placeholder](../../images/fl-w8-s1-hero.png)

**Capture checklist:** local unlock → `/learn/finance/15` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
