# Facilitator guide — AI Literacy · Week 6 · Session 1

**Lesson id:** `ai-11` · **URL:** `/learn/ai/11`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-11` |
| **Title** | Don't Trust — Verify |
| **Time** | 40–55 min |
| **Week theme** | Using AI Well |
| **Student goal** | Complete **Don't Trust — Verify** and demonstrate the week focus: Fact-check AI output and use it honestly for schoolwork. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 550 · Fact Checker |
...
- [ ] Open `/learn/ai/11` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w6-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w6-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w6-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w6-s1-editor.png` |
| E | Success / check state | `ai-w6-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w6-s1-console.png` |

![Hero placeholder](../../images/ai-w6-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/11` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
