# Facilitator guide — AI Literacy · Week 6 · Session 2

**Lesson id:** `ai-12` · **URL:** `/learn/ai/12`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-12` |
| **Title** | AI at School: Help vs. Cheating |
| **Time** | 40–55 min |
| **Week theme** | Using AI Well |
| **Student goal** | Complete **AI at School: Help vs. Cheating** and demonstrate the week focus: Fact-check AI output and use it honestly for schoolwork. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 600 · Honest Scholar |
...
- [ ] Open `/learn/ai/12` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Fact-check AI output and use it honestly for schoolwork.* | Follow Lesson tab |
...
Week theme: **Using AI Well**.  
Focus: Fact-check AI output and use it honestly for schoolwork.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w6-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w6-s2-tabs.png` |
| C | Help / Coach guidance open | `ai-w6-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w6-s2-editor.png` |
| E | Success / check state | `ai-w6-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w6-s2-console.png` |

![Hero placeholder](../../images/ai-w6-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ai/12` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
