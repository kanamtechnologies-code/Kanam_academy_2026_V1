# Facilitator guide — AI Literacy · Week 3 · Session 1

**Lesson id:** `ai-5` · **URL:** `/learn/ai/5`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-5` |
| **Title** | How AI Learns From Examples |
| **Time** | 40–55 min |
| **Week theme** | How AI Learns |
| **Student goal** | Complete **How AI Learns From Examples** and demonstrate the week focus: Machine learning from examples, training vs. testing, and why AI gets things wrong. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 250 · Pattern Learner |
...
- [ ] Open `/learn/ai/5` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w3-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w3-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w3-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w3-s1-editor.png` |
| E | Success / check state | `ai-w3-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w3-s1-console.png` |

![Hero placeholder](../../images/ai-w3-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/5` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
