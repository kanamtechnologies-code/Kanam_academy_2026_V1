# Facilitator guide — AI Literacy · Week 3 · Session 2

**Lesson id:** `ai-6` · **URL:** `/learn/ai/6`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-6` |
| **Title** | Training, Testing, and Mistakes |
| **Time** | 40–55 min |
| **Week theme** | How AI Learns |
| **Student goal** | Complete **Training, Testing, and Mistakes** and demonstrate the week focus: Machine learning from examples, training vs. testing, and why AI gets things wrong. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 300 · Model Tester |
...
- [ ] Open `/learn/ai/6` on the projector (lesson loads)
...
| ---: | --- | --- | --- |
| 0–5 | **Warm-up** | Ask: “Where did you see AI today — and was it helpful or risky?” | Pair share |
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Machine learning from examples, training vs. testing, and why AI gets things wrong.* | Follow Lesson tab |
...
Week theme: **How AI Learns**.  
Focus: Machine learning from examples, training vs. testing, and why AI gets things wrong.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w3-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w3-s2-tabs.png` |
| C | Help / Coach guidance open | `ai-w3-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w3-s2-editor.png` |
| E | Success / check state | `ai-w3-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w3-s2-console.png` |

![Hero placeholder](../../images/ai-w3-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ai/6` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
