# Facilitator guide — AI Literacy · Week 8 · Session 1

**Lesson id:** `ai-15` · **URL:** `/learn/ai/15`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-15` |
| **Title** | AI and the Future of Work |
| **Time** | 40–55 min |
| **Week theme** | Your Future With AI |
| **Student goal** | Complete **AI and the Future of Work** and demonstrate the week focus: Jobs and creativity, plus a capstone to become an AI-smart citizen. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 750 · Future Ready |
...
- [ ] Open `/learn/ai/15` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Jobs and creativity, plus a capstone to become an AI-smart citizen.* | Follow Lesson tab |
...
Week theme: **Your Future With AI**.  
Focus: Jobs and creativity, plus a capstone to become an AI-smart citizen.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w8-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w8-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w8-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w8-s1-editor.png` |
| E | Success / check state | `ai-w8-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w8-s1-console.png` |

![Hero placeholder](../../images/ai-w8-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/15` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
