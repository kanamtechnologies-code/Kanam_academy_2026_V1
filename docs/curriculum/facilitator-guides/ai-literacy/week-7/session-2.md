# Facilitator guide — AI Literacy · Week 7 · Session 2

**Lesson id:** `ai-14` · **URL:** `/learn/ai/14`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-14` |
| **Title** | Privacy, Deepfakes, and Your Footprint |
| **Time** | 40–55 min |
| **Week theme** | AI, Society & Ethics |
| **Student goal** | Complete **Privacy, Deepfakes, and Your Footprint** and demonstrate the week focus: Bias and fairness, then privacy, deepfakes, and misinformation. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 700 · Privacy Defender |
...
- [ ] Open `/learn/ai/14` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Bias and fairness, then privacy, deepfakes, and misinformation.* | Follow Lesson tab |
...
Week theme: **AI, Society & Ethics**.  
Focus: Bias and fairness, then privacy, deepfakes, and misinformation.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w7-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w7-s2-tabs.png` |
| C | Help / Coach guidance open | `ai-w7-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w7-s2-editor.png` |
| E | Success / check state | `ai-w7-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w7-s2-console.png` |

![Hero placeholder](../../images/ai-w7-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ai/14` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
