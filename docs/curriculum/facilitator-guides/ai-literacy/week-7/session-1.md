# Facilitator guide — AI Literacy · Week 7 · Session 1

**Lesson id:** `ai-13` · **URL:** `/learn/ai/13`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-13` |
| **Title** | Bias, Fairness, and Data |
| **Time** | 40–55 min |
| **Week theme** | AI, Society & Ethics |
| **Student goal** | Complete **Bias, Fairness, and Data** and demonstrate the week focus: Bias and fairness, then privacy, deepfakes, and misinformation. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 650 · Fairness Guardian |
...
- [ ] Open `/learn/ai/13` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w7-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w7-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w7-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w7-s1-editor.png` |
| E | Success / check state | `ai-w7-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w7-s1-console.png` |

![Hero placeholder](../../images/ai-w7-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/13` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
