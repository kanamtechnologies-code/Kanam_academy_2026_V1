# Facilitator guide — AI Literacy · Week 2 · Session 2

**Lesson id:** `ai-4` · **URL:** `/learn/ai/4`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-4` |
| **Title** | Turning the World Into Data |
| **Time** | 40–55 min |
| **Week theme** | How Machines Sense & Represent |
| **Student goal** | Complete **Turning the World Into Data** and demonstrate the week focus: Perception (seeing/hearing) and turning the messy world into data. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 200 · Data Translator |
...
- [ ] Open `/learn/ai/4` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Perception (seeing/hearing) and turning the messy world into data.* | Follow Lesson tab |
...
Week theme: **How Machines Sense & Represent**.  
Focus: Perception (seeing/hearing) and turning the messy world into data.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w2-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w2-s2-tabs.png` |
| C | Help / Coach guidance open | `ai-w2-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w2-s2-editor.png` |
| E | Success / check state | `ai-w2-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w2-s2-console.png` |

![Hero placeholder](../../images/ai-w2-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ai/4` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
