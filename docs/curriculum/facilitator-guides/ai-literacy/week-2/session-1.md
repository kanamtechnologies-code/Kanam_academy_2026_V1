# Facilitator guide — AI Literacy · Week 2 · Session 1

**Lesson id:** `ai-3` · **URL:** `/learn/ai/3`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-3` |
| **Title** | How Computers See and Hear |
| **Time** | 40–55 min |
| **Week theme** | How Machines Sense & Represent |
| **Student goal** | Complete **How Computers See and Hear** and demonstrate the week focus: Perception (seeing/hearing) and turning the messy world into data. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 150 · Sense Maker |
...
- [ ] Open `/learn/ai/3` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w2-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w2-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w2-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w2-s1-editor.png` |
| E | Success / check state | `ai-w2-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w2-s1-console.png` |

![Hero placeholder](../../images/ai-w2-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/3` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
