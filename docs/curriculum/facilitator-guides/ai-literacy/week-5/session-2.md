# Facilitator guide — AI Literacy · Week 5 · Session 2

**Lesson id:** `ai-10` · **URL:** `/learn/ai/10`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-10` |
| **Title** | Better Prompts, Better Answers |
| **Time** | 40–55 min |
| **Week theme** | Talking to AI: Prompting |
| **Student goal** | Complete **Better Prompts, Better Answers** and demonstrate the week focus: Write clear prompts, add context, and refine answers like a pro. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 500 · Prompt Pro |
...
- [ ] Open `/learn/ai/10` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w5-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w5-s2-tabs.png` |
| C | Help / Coach guidance open | `ai-w5-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w5-s2-editor.png` |
| E | Success / check state | `ai-w5-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w5-s2-console.png` |

![Hero placeholder](../../images/ai-w5-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ai/10` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
