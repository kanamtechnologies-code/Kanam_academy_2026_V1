# Facilitator guide — AI Literacy · Week 5 · Session 1

**Lesson id:** `ai-9` · **URL:** `/learn/ai/9`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-9` |
| **Title** | How to Talk to AI (Prompting) |
| **Time** | 40–55 min |
| **Week theme** | Talking to AI: Prompting |
| **Student goal** | Complete **How to Talk to AI (Prompting)** and demonstrate the week focus: Write clear prompts, add context, and refine answers like a pro. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 450 · Prompt Starter |
...
- [ ] Open `/learn/ai/9` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Write clear prompts, add context, and refine answers like a pro.* | Follow Lesson tab |
...
Week theme: **Talking to AI: Prompting**.  
Focus: Write clear prompts, add context, and refine answers like a pro.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w5-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w5-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w5-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w5-s1-editor.png` |
| E | Success / check state | `ai-w5-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w5-s1-console.png` |

![Hero placeholder](../../images/ai-w5-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/9` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
