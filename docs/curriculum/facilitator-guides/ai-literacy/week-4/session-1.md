# Facilitator guide — AI Literacy · Week 4 · Session 1

**Lesson id:** `ai-7` · **URL:** `/learn/ai/7`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-7` |
| **Title** | What Is Generative AI? |
| **Time** | 40–55 min |
| **Week theme** | Generative AI & LLMs |
| **Student goal** | Complete **What Is Generative AI?** and demonstrate the week focus: How tools like ChatGPT and image generators create new text and pictures. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 350 · Creator's Apprentice |
...
- [ ] Open `/learn/ai/7` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *How tools like ChatGPT and image generators create new text and pictures.* | Follow Lesson tab |
...
Week theme: **Generative AI & LLMs**.  
Focus: How tools like ChatGPT and image generators create new text and pictures.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w4-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w4-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w4-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w4-s1-editor.png` |
| E | Success / check state | `ai-w4-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w4-s1-console.png` |

![Hero placeholder](../../images/ai-w4-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/7` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
