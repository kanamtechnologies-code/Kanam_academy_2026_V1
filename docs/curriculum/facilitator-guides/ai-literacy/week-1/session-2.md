# Facilitator guide — AI Literacy · Week 1 · Session 2

**Lesson id:** `ai-2` · **URL:** `/learn/ai/2`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-2` |
| **Title** | AI Is All Around You |
| **Time** | 40–55 min |
| **Week theme** | What AI Really Is |
| **Student goal** | Complete **AI Is All Around You** and demonstrate the week focus: Define artificial intelligence and spot where it already shapes your day. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 100 · AI Spotter |
...
- [ ] Open `/learn/ai/2` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Define artificial intelligence and spot where it already shapes your day.* | Follow Lesson tab |
...
Week theme: **What AI Really Is**.  
Focus: Define artificial intelligence and spot where it already shapes your day.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w1-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w1-s2-tabs.png` |
| C | Help / Coach guidance open | `ai-w1-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w1-s2-editor.png` |
| E | Success / check state | `ai-w1-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w1-s2-console.png` |

![Hero placeholder](../../images/ai-w1-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ai/2` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
