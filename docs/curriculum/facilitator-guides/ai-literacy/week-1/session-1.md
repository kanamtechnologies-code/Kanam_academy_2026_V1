# Facilitator guide — AI Literacy · Week 1 · Session 1

**Lesson id:** `ai-1` · **URL:** `/learn/ai/1`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ai-literacy` / `ai-1` |
| **Title** | What Is AI, Really? |
| **Time** | 40–55 min |
| **Week theme** | What AI Really Is |
| **Student goal** | Complete **What Is AI, Really?** and demonstrate the week focus: Define artificial intelligence and spot where it already shapes your day. |
| **Standards** | ISTE · CSTA IC (see literacy crosswalk) |
| **Materials** | Browser devices · projector · discussion space |
| **XP / badge** | 50 · AI Explorer |
...
- [ ] Open `/learn/ai/1` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `ai-w1-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `ai-w1-s1-tabs.png` |
| C | Help / Coach guidance open | `ai-w1-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `ai-w1-s1-editor.png` |
| E | Success / check state | `ai-w1-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `ai-w1-s1-console.png` |

![Hero placeholder](../../images/ai-w1-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ai/1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
