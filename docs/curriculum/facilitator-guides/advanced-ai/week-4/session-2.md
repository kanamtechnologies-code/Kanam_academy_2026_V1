# Facilitator guide — Advanced AI · Week 4 · Session 2

**Lesson id:** `aai-8` · **URL:** `/learn/advanced-ai/8`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-8` |
| **Title** | Agents, Tools & Workflows |
| **Time** | 50–70 min |
| **Week theme** | LLMs Beyond Prompts |
| **Student goal** | Complete **Agents, Tools & Workflows** and demonstrate the week focus: Tokens, embeddings, evaluation, and retrieval-augmented generation (RAG). |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 400 · Agent Architect |
...
- [ ] Open `/learn/advanced-ai/8` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w4-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w4-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w4-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w4-s2-editor.png` |
| E | Success / check state | `aai-w4-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w4-s2-console.png` |

![Hero placeholder](../../images/aai-w4-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/8` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
