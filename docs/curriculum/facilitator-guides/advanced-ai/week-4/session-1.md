# Facilitator guide — Advanced AI · Week 4 · Session 1

**Lesson id:** `aai-7` · **URL:** `/learn/advanced-ai/7`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-7` |
| **Title** | Retrieval-Augmented Generation (RAG) |
| **Time** | 50–70 min |
| **Week theme** | LLMs Beyond Prompts |
| **Student goal** | Complete **Retrieval-Augmented Generation (RAG)** and demonstrate the week focus: Tokens, embeddings, evaluation, and retrieval-augmented generation (RAG). |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 350 · Retrieval Pro |
...
- [ ] Open `/learn/advanced-ai/7` on the projector (lesson loads)
...
Week theme: **LLMs Beyond Prompts**.  
Focus: Tokens, embeddings, evaluation, and retrieval-augmented generation (RAG).
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w4-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w4-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w4-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w4-s1-editor.png` |
| E | Success / check state | `aai-w4-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w4-s1-console.png` |

![Hero placeholder](../../images/aai-w4-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/7` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
