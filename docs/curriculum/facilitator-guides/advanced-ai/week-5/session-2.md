# Facilitator guide — Advanced AI · Week 5 · Session 2

**Lesson id:** `aai-10` · **URL:** `/learn/advanced-ai/10`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-10` |
| **Title** | Fine-Tuning vs Prompting vs RAG |
| **Time** | 50–70 min |
| **Week theme** | Agents & Evaluation |
| **Student goal** | Complete **Fine-Tuning vs Prompting vs RAG** and demonstrate the week focus: Tool-using agents, budgets, human gates, and evaluation harnesses. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 500 · Stack Chooser |
...
- [ ] Open `/learn/advanced-ai/10` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w5-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w5-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w5-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w5-s2-editor.png` |
| E | Success / check state | `aai-w5-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w5-s2-console.png` |

![Hero placeholder](../../images/aai-w5-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/10` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
