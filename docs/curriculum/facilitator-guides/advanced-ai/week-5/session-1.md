# Facilitator guide — Advanced AI · Week 5 · Session 1

**Lesson id:** `aai-9` · **URL:** `/learn/advanced-ai/9`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-9` |
| **Title** | Evaluation Harnesses & Experiment Tracking |
| **Time** | 50–70 min |
| **Week theme** | Agents & Evaluation |
| **Student goal** | Complete **Evaluation Harnesses & Experiment Tracking** and demonstrate the week focus: Tool-using agents, budgets, human gates, and evaluation harnesses. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 450 · Eval Engineer |
...
- [ ] Open `/learn/advanced-ai/9` on the projector (lesson loads)
...
Week theme: **Agents & Evaluation**.  
Focus: Tool-using agents, budgets, human gates, and evaluation harnesses.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w5-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w5-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w5-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w5-s1-editor.png` |
| E | Success / check state | `aai-w5-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w5-s1-console.png` |

![Hero placeholder](../../images/aai-w5-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/9` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
