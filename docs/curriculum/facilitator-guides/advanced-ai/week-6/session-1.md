# Facilitator guide — Advanced AI · Week 6 · Session 1

**Lesson id:** `aai-11` · **URL:** `/learn/advanced-ai/11`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-11` |
| **Title** | Bias Audits & Fairness Metrics |
| **Time** | 50–70 min |
| **Week theme** | Stack Choices & Audits |
| **Student goal** | Complete **Bias Audits & Fairness Metrics** and demonstrate the week focus: Prompt vs RAG vs fine-tune, fairness audits, and AI security. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 550 · Fairness Auditor |
...
- [ ] Open `/learn/advanced-ai/11` on the projector (lesson loads)
...
Week theme: **Stack Choices & Audits**.  
Focus: Prompt vs RAG vs fine-tune, fairness audits, and AI security.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w6-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w6-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w6-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w6-s1-editor.png` |
| E | Success / check state | `aai-w6-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w6-s1-console.png` |

![Hero placeholder](../../images/aai-w6-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/11` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
