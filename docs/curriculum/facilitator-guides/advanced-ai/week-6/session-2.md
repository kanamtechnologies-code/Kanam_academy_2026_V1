# Facilitator guide — Advanced AI · Week 6 · Session 2

**Lesson id:** `aai-12` · **URL:** `/learn/advanced-ai/12`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-12` |
| **Title** | Privacy, Security & Model Abuse |
| **Time** | 50–70 min |
| **Week theme** | Stack Choices & Audits |
| **Student goal** | Complete **Privacy, Security & Model Abuse** and demonstrate the week focus: Prompt vs RAG vs fine-tune, fairness audits, and AI security. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 600 · AI Defender |
...
- [ ] Open `/learn/advanced-ai/12` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w6-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w6-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w6-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w6-s2-editor.png` |
| E | Success / check state | `aai-w6-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w6-s2-console.png` |

![Hero placeholder](../../images/aai-w6-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/12` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
