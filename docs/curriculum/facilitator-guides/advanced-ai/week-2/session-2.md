# Facilitator guide — Advanced AI · Week 2 · Session 2

**Lesson id:** `aai-4` · **URL:** `/learn/advanced-ai/4`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-4` |
| **Title** | Neural Networks: From Neurons to Overfitting |
| **Time** | 50–70 min |
| **Week theme** | Classical ML You Can See |
| **Student goal** | Complete **Neural Networks: From Neurons to Overfitting** and demonstrate the week focus: Train classifiers, read confusion matrices, precision/recall, and baselines. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 200 · Net Navigator |
...
- [ ] Open `/learn/advanced-ai/4` on the projector (lesson loads)
...
Week theme: **Classical ML You Can See**.  
Focus: Train classifiers, read confusion matrices, precision/recall, and baselines.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w2-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w2-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w2-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w2-s2-editor.png` |
| E | Success / check state | `aai-w2-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w2-s2-console.png` |

![Hero placeholder](../../images/aai-w2-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/4` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
