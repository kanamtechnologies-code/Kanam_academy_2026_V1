# Facilitator guide — Advanced AI · Week 2 · Session 1

**Lesson id:** `aai-3` · **URL:** `/learn/advanced-ai/3`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-3` |
| **Title** | Train Your First Classifier |
| **Time** | 50–70 min |
| **Week theme** | Classical ML You Can See |
| **Student goal** | Complete **Train Your First Classifier** and demonstrate the week focus: Train classifiers, read confusion matrices, precision/recall, and baselines. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 150 · Model Trainer |
...
- [ ] Open `/learn/advanced-ai/3` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w2-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w2-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w2-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w2-s1-editor.png` |
| E | Success / check state | `aai-w2-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w2-s1-console.png` |

![Hero placeholder](../../images/aai-w2-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/3` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
