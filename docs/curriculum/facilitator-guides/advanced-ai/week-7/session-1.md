# Facilitator guide — Advanced AI · Week 7 · Session 1

**Lesson id:** `aai-13` · **URL:** `/learn/advanced-ai/13`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-13` |
| **Title** | MLOps Lite: Deploy, Monitor, Drift |
| **Time** | 50–70 min |
| **Week theme** | Ship & Integrate |
| **Student goal** | Complete **MLOps Lite: Deploy, Monitor, Drift** and demonstrate the week focus: MLOps lite — deploy, monitor, drift — plus multimodal system design. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 650 · Ship Watcher |
...
- [ ] Open `/learn/advanced-ai/13` on the projector (lesson loads)
...
Week theme: **Ship & Integrate**.  
Focus: MLOps lite — deploy, monitor, drift — plus multimodal system design.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w7-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w7-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w7-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w7-s1-editor.png` |
| E | Success / check state | `aai-w7-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w7-s1-console.png` |

![Hero placeholder](../../images/aai-w7-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/13` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
