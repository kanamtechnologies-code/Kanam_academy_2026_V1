# Facilitator guide — Advanced AI · Week 1 · Session 1

**Lesson id:** `aai-1` · **URL:** `/learn/advanced-ai/1`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-1` |
| **Title** | AI Systems: Framing Problems Worth Solving |
| **Time** | 50–70 min |
| **Week theme** | Frame & Data |
| **Student goal** | Complete **AI Systems: Framing Problems Worth Solving** and demonstrate the week focus: Problem framing, task types, features/labels, leakage, and dataset bias. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 50 · Problem Framer |
...
- [ ] Open `/learn/advanced-ai/1` on the projector (lesson loads)
...
Week theme: **Frame & Data**.  
Focus: Problem framing, task types, features/labels, leakage, and dataset bias.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w1-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w1-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w1-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w1-s1-editor.png` |
| E | Success / check state | `aai-w1-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w1-s1-console.png` |

![Hero placeholder](../../images/aai-w1-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
