# Facilitator guide — Advanced AI · Week 1 · Session 2

**Lesson id:** `aai-2` · **URL:** `/learn/advanced-ai/2`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-2` |
| **Title** | Data for Machine Learning |
| **Time** | 50–70 min |
| **Week theme** | Frame & Data |
| **Student goal** | Complete **Data for Machine Learning** and demonstrate the week focus: Problem framing, task types, features/labels, leakage, and dataset bias. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 100 · Data Steward |
...
- [ ] Open `/learn/advanced-ai/2` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w1-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w1-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w1-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w1-s2-editor.png` |
| E | Success / check state | `aai-w1-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w1-s2-console.png` |

![Hero placeholder](../../images/aai-w1-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/2` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
