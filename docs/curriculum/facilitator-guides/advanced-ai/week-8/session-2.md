# Facilitator guide — Advanced AI · Week 8 · Session 2

**Lesson id:** `aai-16` · **URL:** `/learn/advanced-ai/16`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-16` |
| **Title** | Capstone: Demo, Audit & Defend |
| **Time** | 50–70 min |
| **Week theme** | Capstone |
| **Student goal** | Complete **Capstone: Demo, Audit & Defend** and demonstrate the week focus: Build a thin AI system, then demo, audit, and defend it. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 800 · AI Systems Graduate |
...
- [ ] Open `/learn/advanced-ai/16` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w8-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w8-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w8-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w8-s2-editor.png` |
| E | Success / check state | `aai-w8-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w8-s2-console.png` |

![Hero placeholder](../../images/aai-w8-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/16` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
