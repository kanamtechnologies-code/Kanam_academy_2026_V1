# Facilitator guide — Advanced AI · Week 8 · Session 1

**Lesson id:** `aai-15` · **URL:** `/learn/advanced-ai/15`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-15` |
| **Title** | Capstone Studio: Build Your AI System |
| **Time** | 50–70 min |
| **Week theme** | Capstone |
| **Student goal** | Complete **Capstone Studio: Build Your AI System** and demonstrate the week focus: Build a thin AI system, then demo, audit, and defend it. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 750 · Capstone Builder |
...
- [ ] Open `/learn/advanced-ai/15` on the projector (lesson loads)
...
Week theme: **Capstone**.  
Focus: Build a thin AI system, then demo, audit, and defend it.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w8-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w8-s1-tabs.png` |
| C | Help / Coach guidance open | `aai-w8-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w8-s1-editor.png` |
| E | Success / check state | `aai-w8-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w8-s1-console.png` |

![Hero placeholder](../../images/aai-w8-s1-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/15` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
