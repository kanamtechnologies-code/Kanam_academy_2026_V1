# Facilitator guide — Advanced AI · Week 3 · Session 2

**Lesson id:** `aai-6` · **URL:** `/learn/advanced-ai/6`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `advanced-ai` / `aai-6` |
| **Title** | Language Models Beyond Prompting |
| **Time** | 50–70 min |
| **Week theme** | Neural Nets & Vision |
| **Student goal** | Complete **Language Models Beyond Prompting** and demonstrate the week focus: Layers, overfitting, and computer-vision pipelines with privacy checks. |
| **Standards** | CSTA AI specialty / IC · DA |
| **Materials** | Browser devices · projector · note-taking for audits |
| **XP / badge** | 300 · LLM Engineer |
...
- [ ] Open `/learn/advanced-ai/6` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `aai-w3-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `aai-w3-s2-tabs.png` |
| C | Help / Coach guidance open | `aai-w3-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `aai-w3-s2-editor.png` |
| E | Success / check state | `aai-w3-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `aai-w3-s2-console.png` |

![Hero placeholder](../../images/aai-w3-s2-hero.png)

**Capture checklist:** local unlock → `/learn/advanced-ai/6` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
