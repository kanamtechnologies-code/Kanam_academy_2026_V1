# Facilitator guide — Cybersecurity · Week 4 · Session 2

**Lesson id:** `cs-8` · **URL:** `/learn/cyber/8`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-8` |
| **Title** | Firewalls, Ports & Secure Config |
| **Time** | 45–60 min |
| **Week theme** | Networks & Defense Architecture |
| **Student goal** | Complete **Firewalls, Ports & Secure Config** and demonstrate the week focus: Evaluate network reliability (routers, switches, topology, addressing) and recommend firewall/config controls. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 400 · Firewall Builder |
...
- [ ] Open `/learn/cyber/8` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w4-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w4-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w4-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w4-s2-editor.png` |
| E | Success / check state | `cs-w4-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w4-s2-console.png` |

![Hero placeholder](../../images/cs-w4-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/8` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
