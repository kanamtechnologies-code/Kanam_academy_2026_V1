# Facilitator guide — Cybersecurity · Week 4 · Session 1

**Lesson id:** `cs-7` · **URL:** `/learn/cyber/7`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-7` |
| **Title** | Network Architecture for Defenders |
| **Time** | 45–60 min |
| **Week theme** | Networks & Defense Architecture |
| **Student goal** | Complete **Network Architecture for Defenders** and demonstrate the week focus: Evaluate network reliability (routers, switches, topology, addressing) and recommend firewall/config controls. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 350 · Net Scout |
...
- [ ] Open `/learn/cyber/7` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Evaluate network reliability (routers, switches, topology, addressing) and recommend firewall/config controls.* | Follow Lesson tab |
...
Week theme: **Networks & Defense Architecture**.  
Focus: Evaluate network reliability (routers, switches, topology, addressing) and recommend firewall/config controls.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w4-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w4-s1-tabs.png` |
| C | Help / Coach guidance open | `cs-w4-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w4-s1-editor.png` |
| E | Success / check state | `cs-w4-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w4-s1-console.png` |

![Hero placeholder](../../images/cs-w4-s1-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/7` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
