# Facilitator guide — Cybersecurity · Week 2 · Session 1

**Lesson id:** `cs-3` · **URL:** `/learn/cyber/3`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-3` |
| **Title** | Malware Impact on Sensitive Data |
| **Time** | 45–60 min |
| **Week theme** | Threats & Human Risk |
| **Student goal** | Complete **Malware Impact on Sensitive Data** and demonstrate the week focus: Analyze how malware and social engineering affect sensitive data — and recommend first responses. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 150 · Threat Spotter |
...
- [ ] Open `/learn/cyber/3` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Analyze how malware and social engineering affect sensitive data — and recommend first responses.* | Follow Lesson tab |
...
Week theme: **Threats & Human Risk**.  
Focus: Analyze how malware and social engineering affect sensitive data — and recommend first responses.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w2-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w2-s1-tabs.png` |
| C | Help / Coach guidance open | `cs-w2-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w2-s1-editor.png` |
| E | Success / check state | `cs-w2-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w2-s1-console.png` |

![Hero placeholder](../../images/cs-w2-s1-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/3` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
