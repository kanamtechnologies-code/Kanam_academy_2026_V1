# Facilitator guide — Cybersecurity · Week 2 · Session 2

**Lesson id:** `cs-4` · **URL:** `/learn/cyber/4`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-4` |
| **Title** | Social Engineering Defense |
| **Time** | 45–60 min |
| **Week theme** | Threats & Human Risk |
| **Student goal** | Complete **Social Engineering Defense** and demonstrate the week focus: Analyze how malware and social engineering affect sensitive data — and recommend first responses. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 200 · Phish Defender |
...
- [ ] Open `/learn/cyber/4` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w2-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w2-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w2-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w2-s2-editor.png` |
| E | Success / check state | `cs-w2-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w2-s2-console.png` |

![Hero placeholder](../../images/cs-w2-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/4` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
