# Facilitator guide — Cybersecurity · Week 6 · Session 2

**Lesson id:** `cs-12` · **URL:** `/learn/cyber/12`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-12` |
| **Title** | Logging, Monitoring & Incidents |
| **Time** | 45–60 min |
| **Week theme** | Hardening & Incident Response |
| **Student goal** | Complete **Logging, Monitoring & Incidents** and demonstrate the week focus: Recommend hardening/patching priorities, then design logging, monitoring, and incident workflows. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 600 · Incident Ready |
...
- [ ] Open `/learn/cyber/12` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Recommend hardening/patching priorities, then design logging, monitoring, and incident workflows.* | Follow Lesson tab |
...
Week theme: **Hardening & Incident Response**.  
Focus: Recommend hardening/patching priorities, then design logging, monitoring, and incident workflows.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w6-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w6-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w6-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w6-s2-editor.png` |
| E | Success / check state | `cs-w6-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w6-s2-console.png` |

![Hero placeholder](../../images/cs-w6-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/12` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
