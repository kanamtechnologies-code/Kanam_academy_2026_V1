# Facilitator guide — Cybersecurity · Week 6 · Session 1

**Lesson id:** `cs-11` · **URL:** `/learn/cyber/11`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-11` |
| **Title** | System Hardening & Patching |
| **Time** | 45–60 min |
| **Week theme** | Hardening & Incident Response |
| **Student goal** | Complete **System Hardening & Patching** and demonstrate the week focus: Recommend hardening/patching priorities, then design logging, monitoring, and incident workflows. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 550 · Hardener |
...
- [ ] Open `/learn/cyber/11` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w6-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w6-s1-tabs.png` |
| C | Help / Coach guidance open | `cs-w6-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w6-s1-editor.png` |
| E | Success / check state | `cs-w6-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w6-s1-console.png` |

![Hero placeholder](../../images/cs-w6-s1-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/11` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
