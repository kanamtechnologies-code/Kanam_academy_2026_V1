# Facilitator guide — Cybersecurity · Week 5 · Session 2

**Lesson id:** `cs-10` · **URL:** `/learn/cyber/10`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-10` |
| **Title** | HTTPS, Certificates & Trust |
| **Time** | 45–60 min |
| **Week theme** | Cryptography & Trust Models |
| **Student goal** | Complete **HTTPS, Certificates & Trust** and demonstrate the week focus: Compare encryption and hashing approaches, then evaluate HTTPS/certificate trust and its limits. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 500 · Trust Verifier |
...
- [ ] Open `/learn/cyber/10` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Compare encryption and hashing approaches, then evaluate HTTPS/certificate trust and its limits.* | Follow Lesson tab |
...
Week theme: **Cryptography & Trust Models**.  
Focus: Compare encryption and hashing approaches, then evaluate HTTPS/certificate trust and its limits.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w5-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w5-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w5-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w5-s2-editor.png` |
| E | Success / check state | `cs-w5-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w5-s2-console.png` |

![Hero placeholder](../../images/cs-w5-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/10` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
