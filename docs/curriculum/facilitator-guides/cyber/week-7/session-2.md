# Facilitator guide — Cybersecurity · Week 7 · Session 2

**Lesson id:** `cs-14` · **URL:** `/learn/cyber/14`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-14` |
| **Title** | OSINT, Privacy & Ethics |
| **Time** | 45–60 min |
| **Week theme** | Attacks, Privacy & Tradeoffs |
| **Student goal** | Complete **OSINT, Privacy & Ethics** and demonstrate the week focus: Map attack patterns and program-security issues, then evaluate OSINT/privacy risks and legal-ethical tradeoffs. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 700 · Privacy Scout |
...
- [ ] Open `/learn/cyber/14` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w7-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w7-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w7-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w7-s2-editor.png` |
| E | Success / check state | `cs-w7-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w7-s2-console.png` |

![Hero placeholder](../../images/cs-w7-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/14` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
