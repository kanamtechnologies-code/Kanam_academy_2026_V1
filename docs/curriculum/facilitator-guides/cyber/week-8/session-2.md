# Facilitator guide — Cybersecurity · Week 8 · Session 2

**Lesson id:** `cs-16` · **URL:** `/learn/cyber/16`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-16` |
| **Title** | Capstone: Defend & Justify |
| **Time** | 45–60 min |
| **Week theme** | Risk Analysis & Capstone |
| **Student goal** | Complete **Capstone: Defend & Justify** and demonstrate the week focus: Select and justify controls by feasibility, ethics, and usability — then defend a full scenario plan. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 800 · Cyber Defender |
...
- [ ] Open `/learn/cyber/16` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Select and justify controls by feasibility, ethics, and usability — then defend a full scenario plan.* | Follow Lesson tab |
...
Week theme: **Risk Analysis & Capstone**.  
Focus: Select and justify controls by feasibility, ethics, and usability — then defend a full scenario plan.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w8-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w8-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w8-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w8-s2-editor.png` |
| E | Success / check state | `cs-w8-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w8-s2-console.png` |

![Hero placeholder](../../images/cs-w8-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/16` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
