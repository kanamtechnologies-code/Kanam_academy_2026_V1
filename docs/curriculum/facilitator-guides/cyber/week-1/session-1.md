# Facilitator guide — Cybersecurity · Week 1 · Session 1

**Lesson id:** `cs-1` · **URL:** `/learn/cyber/1`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-1` |
| **Title** | Cybersecurity Principles & Ethics |
| **Time** | 45–60 min |
| **Week theme** | Principles & Ethics |
| **Student goal** | Complete **Cybersecurity Principles & Ethics** and demonstrate the week focus: Define cybersecurity goals, evaluate ethical constraints, and apply the CIA triad with authentication. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 50 · Cyber Rookie |
...
- [ ] Open `/learn/cyber/1` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w1-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w1-s1-tabs.png` |
| C | Help / Coach guidance open | `cs-w1-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w1-s1-editor.png` |
| E | Success / check state | `cs-w1-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w1-s1-console.png` |

![Hero placeholder](../../images/cs-w1-s1-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
