# Facilitator guide — Cybersecurity · Week 3 · Session 1

**Lesson id:** `cs-5` · **URL:** `/learn/cyber/5`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-5` |
| **Title** | Credentials, Hashing & MFA |
| **Time** | 45–60 min |
| **Week theme** | Identity & Access Control |
| **Student goal** | Complete **Credentials, Hashing & MFA** and demonstrate the week focus: Compare credential protections (hashing, MFA) and design least-privilege access with usability tradeoffs. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 250 · Credential Pro |
...
- [ ] Open `/learn/cyber/5` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Compare credential protections (hashing, MFA) and design least-privilege access with usability tradeoffs.* | Follow Lesson tab |
...
Week theme: **Identity & Access Control**.  
Focus: Compare credential protections (hashing, MFA) and design least-privilege access with usability tradeoffs.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w3-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w3-s1-tabs.png` |
| C | Help / Coach guidance open | `cs-w3-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w3-s1-editor.png` |
| E | Success / check state | `cs-w3-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w3-s1-console.png` |

![Hero placeholder](../../images/cs-w3-s1-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/5` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
