# Facilitator guide — Cybersecurity · Week 3 · Session 2

**Lesson id:** `cs-6` · **URL:** `/learn/cyber/6`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `cybersecurity` / `cs-6` |
| **Title** | Access Control & Least Privilege |
| **Time** | 45–60 min |
| **Week theme** | Identity & Access Control |
| **Student goal** | Complete **Access Control & Least Privilege** and demonstrate the week focus: Compare credential protections (hashing, MFA) and design least-privilege access with usability tradeoffs. |
| **Standards** | CSTA 3A/3B security & IC |
| **Materials** | Browser devices · projector · no live-system attacks |
| **XP / badge** | 300 · Gatekeeper |
...
- [ ] Open `/learn/cyber/6` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `cs-w3-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `cs-w3-s2-tabs.png` |
| C | Help / Coach guidance open | `cs-w3-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `cs-w3-s2-editor.png` |
| E | Success / check state | `cs-w3-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `cs-w3-s2-console.png` |

![Hero placeholder](../../images/cs-w3-s2-hero.png)

**Capture checklist:** local unlock → `/learn/cyber/6` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
