# Facilitator guide — Data Analyst · Week 1 · Session 2

**Lesson id:** `da-2` · **URL:** `/learn/data/2`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `data-analyst` / `da-2` |
| **Title** | Your First Query |
| **Time** | 45–60 min |
| **Week theme** | What Data Is |
| **Student goal** | Write and run complete SQL queries — see every row, use LIMIT, and pick the columns you care about. |
| **Standards** | CSTA 2-DA / 3A-DA · CCSS SP (see track doc) |
| **Materials** | Browser devices · projector · SQL workspace visible |
| **XP / badge** | 100 · Query Starter |
...
- [ ] Open `/learn/data/2` on the projector (lesson loads)
...
| ---: | --- | --- | --- |
| 0–5 | **Warm-up** | Ask a real-world question the data could answer today (theme: What Data Is). | Think / pair share |
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `data-w1-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `data-w1-s2-tabs.png` |
| C | Help / Coach guidance open | `data-w1-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `data-w1-s2-editor.png` |
| E | Success / check state | `data-w1-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `data-w1-s2-console.png` |

![Hero placeholder](../../images/data-w1-s2-hero.png)

**Capture checklist:** local unlock → `/learn/data/2` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
