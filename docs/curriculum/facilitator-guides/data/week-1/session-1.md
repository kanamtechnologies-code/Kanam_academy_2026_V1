# Facilitator guide — Data Analyst · Week 1 · Session 1

**Lesson id:** `da-1` · **URL:** `/learn/data/1`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `data-analyst` / `da-1` |
| **Title** | What Is Data? |
| **Time** | 45–60 min |
| **Week theme** | What Data Is |
| **Student goal** | Learn rows, columns, and your first SQL commands — one exercise at a time, then put them together. |
| **Standards** | CSTA 2-DA / 3A-DA · CCSS SP (see track doc) |
| **Materials** | Browser devices · projector · SQL workspace visible |
| **XP / badge** | 50 · Data Spotter |
...
- [ ] Open `/learn/data/1` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `data-w1-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `data-w1-s1-tabs.png` |
| C | Help / Coach guidance open | `data-w1-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `data-w1-s1-editor.png` |
| E | Success / check state | `data-w1-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `data-w1-s1-console.png` |

![Hero placeholder](../../images/data-w1-s1-hero.png)

**Capture checklist:** local unlock → `/learn/data/1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
