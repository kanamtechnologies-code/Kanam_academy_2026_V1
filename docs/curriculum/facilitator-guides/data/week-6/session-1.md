# Facilitator guide — Data Analyst · Week 6 · Session 1

**Lesson id:** `da-11` · **URL:** `/learn/data/11`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `data-analyst` / `da-11` |
| **Title** | Change Over Time |
| **Time** | 45–60 min |
| **Week theme** | Trends & Spread |
| **Student goal** | Use a line chart to show how a number changes over time — and read the trend, peaks, and dips across a week. |
| **Standards** | CSTA 2-DA / 3A-DA · CCSS SP (see track doc) |
| **Materials** | Browser devices · projector · SQL workspace visible |
| **XP / badge** | 550 · Trend Spotter |
...
- [ ] Open `/learn/data/11` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `data-w6-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `data-w6-s1-tabs.png` |
| C | Help / Coach guidance open | `data-w6-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `data-w6-s1-editor.png` |
| E | Success / check state | `data-w6-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `data-w6-s1-console.png` |

![Hero placeholder](../../images/data-w6-s1-hero.png)

**Capture checklist:** local unlock → `/learn/data/11` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
