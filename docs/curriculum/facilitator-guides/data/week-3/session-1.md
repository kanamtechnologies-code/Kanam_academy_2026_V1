# Facilitator guide — Data Analyst · Week 3 · Session 1

**Lesson id:** `da-5` · **URL:** `/learn/data/5`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `data-analyst` / `da-5` |
| **Title** | Sort and Rank |
| **Time** | 45–60 min |
| **Week theme** | Sorting & Summarizing |
| **Student goal** | Use ORDER BY to sort rows, flip the direction with DESC, and combine with LIMIT to find top results. |
| **Standards** | CSTA 2-DA / 3A-DA · CCSS SP (see track doc) |
| **Materials** | Browser devices · projector · SQL workspace visible |
| **XP / badge** | 250 · Rank Master |
...
- [ ] Open `/learn/data/5` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `data-w3-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `data-w3-s1-tabs.png` |
| C | Help / Coach guidance open | `data-w3-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `data-w3-s1-editor.png` |
| E | Success / check state | `data-w3-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `data-w3-s1-console.png` |

![Hero placeholder](../../images/data-w3-s1-hero.png)

**Capture checklist:** local unlock → `/learn/data/5` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
