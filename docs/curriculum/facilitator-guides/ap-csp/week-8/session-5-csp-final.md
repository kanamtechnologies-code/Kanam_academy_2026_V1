# Facilitator guide — AP CSP Prep · Week 8 · Session 5

**Lesson id:** `csp-final` · **URL:** `/learn/ap-csp-prep/exam/final` · **Kind:** assessment
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-final` |
| **Title** | Final Exam · 40 AP-Style Questions |
| **Time** | 40–60 min (exam block) |
| **Week theme** | Create PT & Exams |
| **Student goal** | Complete **Final Exam · 40 AP-Style Questions** and demonstrate the week focus: Create Performance Task studio, then gated Practice Tests (30 Q) and Final Exam (40 Q) after all lessons. |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 400 · CSP Finalist |
...
- [ ] Open `/learn/ap-csp-prep/exam/final` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w8-s5-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w8-s5-tabs.png` |
| C | Help / Coach guidance open | `csp-w8-s5-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w8-s5-editor.png` |
| E | Success / check state | `csp-w8-s5-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w8-s5-console.png` |

![Hero placeholder](../../images/csp-w8-s5-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/exam/final` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
