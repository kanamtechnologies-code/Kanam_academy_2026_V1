# Facilitator guide — AP CSP Prep · Week 8 · Session 3

**Lesson id:** `csp-practice-1` · **URL:** `/learn/ap-csp-prep/exam/practice-1` · **Kind:** assessment
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-practice-1` |
| **Title** | Practice Test 1 · 30 AP-Style Questions |
| **Time** | 40–60 min (exam block) |
| **Week theme** | Create PT & Exams |
| **Student goal** | Complete **Practice Test 1 · 30 AP-Style Questions** and demonstrate the week focus: Create Performance Task studio, then gated Practice Tests (30 Q) and Final Exam (40 Q) after all lessons. |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 250 · Practice Ace I |
...
- [ ] Open `/learn/ap-csp-prep/exam/practice-1` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w8-s3-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w8-s3-tabs.png` |
| C | Help / Coach guidance open | `csp-w8-s3-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w8-s3-editor.png` |
| E | Success / check state | `csp-w8-s3-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w8-s3-console.png` |

![Hero placeholder](../../images/csp-w8-s3-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/exam/practice-1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
