# Facilitator guide — AP CSP Prep · Week 8 · Session 2

**Lesson id:** `csp-16` · **URL:** `/learn/ap-csp-prep/16`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-16` |
| **Title** | AP-Style Practice Gauntlet & Exam Readiness |
| **Time** | 45–60 min |
| **Week theme** | Create PT & Exams |
| **Student goal** | Complete **AP-Style Practice Gauntlet & Exam Readiness** and demonstrate the week focus: Create Performance Task studio, then gated Practice Tests (30 Q) and Final Exam (40 Q) after all lessons. |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 800 · CSP Exam Ready |
...
- [ ] Open `/learn/ap-csp-prep/16` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w8-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w8-s2-tabs.png` |
| C | Help / Coach guidance open | `csp-w8-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w8-s2-editor.png` |
| E | Success / check state | `csp-w8-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w8-s2-console.png` |

![Hero placeholder](../../images/csp-w8-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/16` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
