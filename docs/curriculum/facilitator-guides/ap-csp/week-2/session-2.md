# Facilitator guide — AP CSP Prep · Week 2 · Session 2

**Lesson id:** `csp-4` · **URL:** `/learn/ap-csp-prep/4`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-4` |
| **Title** | Compression, Metadata, Bias & Insight from Data |
| **Time** | 45–60 min |
| **Week theme** | Data |
| **Student goal** | Complete **Compression, Metadata, Bias & Insight from Data** and demonstrate the week focus: Bits/binary, abstraction, compression, metadata, bias, and insight from data (Big Idea 2). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 200 · Data Decoder |
...
- [ ] Open `/learn/ap-csp-prep/4` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Bits/binary, abstraction, compression, metadata, bias, and insight from data (Big Idea 2).* | Follow Lesson tab |
...
Week theme: **Data**.  
Focus: Bits/binary, abstraction, compression, metadata, bias, and insight from data (Big Idea 2).
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w2-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w2-s2-tabs.png` |
| C | Help / Coach guidance open | `csp-w2-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w2-s2-editor.png` |
| E | Success / check state | `csp-w2-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w2-s2-console.png` |

![Hero placeholder](../../images/csp-w2-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/4` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
