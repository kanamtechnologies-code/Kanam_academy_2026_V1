# Facilitator guide — AP CSP Prep · Week 2 · Session 1

**Lesson id:** `csp-3` · **URL:** `/learn/ap-csp-prep/3`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-3` |
| **Title** | Bits, Binary & Data Abstraction |
| **Time** | 45–60 min |
| **Week theme** | Data |
| **Student goal** | Complete **Bits, Binary & Data Abstraction** and demonstrate the week focus: Bits/binary, abstraction, compression, metadata, bias, and insight from data (Big Idea 2). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 150 · Bit Builder |
...
- [ ] Open `/learn/ap-csp-prep/3` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w2-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w2-s1-tabs.png` |
| C | Help / Coach guidance open | `csp-w2-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w2-s1-editor.png` |
| E | Success / check state | `csp-w2-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w2-s1-console.png` |

![Hero placeholder](../../images/csp-w2-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/3` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
