# Facilitator guide — AP CSP Prep · Week 5 · Session 1

**Lesson id:** `csp-9` · **URL:** `/learn/ap-csp-prep/9`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-9` |
| **Title** | Procedures, Parameters & Abstraction |
| **Time** | 45–60 min |
| **Week theme** | Programming III |
| **Student goal** | Complete **Procedures, Parameters & Abstraction** and demonstrate the week focus: Procedures, parameters, abstraction, algorithms, and efficiency tradeoffs. |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 450 · Procedure Architect |
...
- [ ] Open `/learn/ap-csp-prep/9` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Procedures, parameters, abstraction, algorithms, and efficiency tradeoffs.* | Follow Lesson tab |
...
Week theme: **Programming III**.  
Focus: Procedures, parameters, abstraction, algorithms, and efficiency tradeoffs.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w5-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w5-s1-tabs.png` |
| C | Help / Coach guidance open | `csp-w5-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w5-s1-editor.png` |
| E | Success / check state | `csp-w5-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w5-s1-console.png` |

![Hero placeholder](../../images/csp-w5-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/9` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
