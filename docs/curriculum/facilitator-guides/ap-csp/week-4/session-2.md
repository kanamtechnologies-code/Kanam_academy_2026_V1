# Facilitator guide — AP CSP Prep · Week 4 · Session 2

**Lesson id:** `csp-8` · **URL:** `/learn/ap-csp-prep/8`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-8` |
| **Title** | Lists & Traversal |
| **Time** | 45–60 min |
| **Week theme** | Programming II |
| **Student goal** | Complete **Lists & Traversal** and demonstrate the week focus: Iteration, lists, and traversal — build patterns you’ll need on the Create PT. |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 400 · List Navigator |
...
- [ ] Open `/learn/ap-csp-prep/8` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Iteration, lists, and traversal — build patterns you’ll need on the Create PT.* | Follow Lesson tab |
...
Week theme: **Programming II**.  
Focus: Iteration, lists, and traversal — build patterns you’ll need on the Create PT.
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w4-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w4-s2-tabs.png` |
| C | Help / Coach guidance open | `csp-w4-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w4-s2-editor.png` |
| E | Success / check state | `csp-w4-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w4-s2-console.png` |

![Hero placeholder](../../images/csp-w4-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/8` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
