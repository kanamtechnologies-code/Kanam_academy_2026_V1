# Facilitator guide — AP CSP Prep · Week 1 · Session 1

**Lesson id:** `csp-1` · **URL:** `/learn/ap-csp-prep/1`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-1` |
| **Title** | Creative Development: Purpose, Collaboration & Iteration |
| **Time** | 45–60 min |
| **Week theme** | Creative Development |
| **Student goal** | Complete **Creative Development: Purpose, Collaboration & Iteration** and demonstrate the week focus: Purpose, collaboration, iteration, testing, and documentation (Big Idea 1). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 50 · Design Collaborator |
...
- [ ] Open `/learn/ap-csp-prep/1` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Purpose, collaboration, iteration, testing, and documentation (Big Idea 1).* | Follow Lesson tab |
...
Week theme: **Creative Development**.  
Focus: Purpose, collaboration, iteration, testing, and documentation (Big Idea 1).
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w1-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w1-s1-tabs.png` |
| C | Help / Coach guidance open | `csp-w1-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w1-s1-editor.png` |
| E | Success / check state | `csp-w1-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w1-s1-console.png` |

![Hero placeholder](../../images/csp-w1-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/1` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
