# Facilitator guide — AP CSP Prep · Week 7 · Session 2

**Lesson id:** `csp-14` · **URL:** `/learn/ap-csp-prep/14`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-14` |
| **Title** | Legal & Ethical Issues: IP, Privacy & Open Source |
| **Time** | 45–60 min |
| **Week theme** | Impact of Computing |
| **Student goal** | Complete **Legal & Ethical Issues: IP, Privacy & Open Source** and demonstrate the week focus: Innovations, equity, legal/ethical issues, IP, and privacy (Big Idea 5). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 700 · Ethics Sentinel |
...
- [ ] Open `/learn/ap-csp-prep/14` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Innovations, equity, legal/ethical issues, IP, and privacy (Big Idea 5).* | Follow Lesson tab |
...
Week theme: **Impact of Computing**.  
Focus: Innovations, equity, legal/ethical issues, IP, and privacy (Big Idea 5).
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w7-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w7-s2-tabs.png` |
| C | Help / Coach guidance open | `csp-w7-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w7-s2-editor.png` |
| E | Success / check state | `csp-w7-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w7-s2-console.png` |

![Hero placeholder](../../images/csp-w7-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/14` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
