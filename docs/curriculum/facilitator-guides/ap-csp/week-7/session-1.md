# Facilitator guide — AP CSP Prep · Week 7 · Session 1

**Lesson id:** `csp-13` · **URL:** `/learn/ap-csp-prep/13`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-13` |
| **Title** | Computing Innovations, Society & Equity |
| **Time** | 45–60 min |
| **Week theme** | Impact of Computing |
| **Student goal** | Complete **Computing Innovations, Society & Equity** and demonstrate the week focus: Innovations, equity, legal/ethical issues, IP, and privacy (Big Idea 5). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 650 · Impact Analyst |
...
- [ ] Open `/learn/ap-csp-prep/13` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w7-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w7-s1-tabs.png` |
| C | Help / Coach guidance open | `csp-w7-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w7-s1-editor.png` |
| E | Success / check state | `csp-w7-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w7-s1-console.png` |

![Hero placeholder](../../images/csp-w7-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/13` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
