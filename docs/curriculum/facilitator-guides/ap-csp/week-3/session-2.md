# Facilitator guide — AP CSP Prep · Week 3 · Session 2

**Lesson id:** `csp-6` · **URL:** `/learn/ap-csp-prep/6`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-6` |
| **Title** | Conditionals & Boolean Logic |
| **Time** | 45–60 min |
| **Week theme** | Programming I |
| **Student goal** | Complete **Conditionals & Boolean Logic** and demonstrate the week focus: Variables, expressions, strings, conditionals, and Boolean logic (Big Idea 3). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 300 · Logic Guard |
...
- [ ] Open `/learn/ap-csp-prep/6` on the projector (lesson loads)
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w3-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w3-s2-tabs.png` |
| C | Help / Coach guidance open | `csp-w3-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w3-s2-editor.png` |
| E | Success / check state | `csp-w3-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w3-s2-console.png` |

![Hero placeholder](../../images/csp-w3-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/6` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
