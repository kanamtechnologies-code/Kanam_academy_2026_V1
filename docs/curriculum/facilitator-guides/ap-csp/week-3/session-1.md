# Facilitator guide — AP CSP Prep · Week 3 · Session 1

**Lesson id:** `csp-5` · **URL:** `/learn/ap-csp-prep/5`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-5` |
| **Title** | Variables, Expressions & Strings |
| **Time** | 45–60 min |
| **Week theme** | Programming I |
| **Student goal** | Complete **Variables, Expressions & Strings** and demonstrate the week focus: Variables, expressions, strings, conditionals, and Boolean logic (Big Idea 3). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 250 · Code Starter |
...
- [ ] Open `/learn/ap-csp-prep/5` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Variables, expressions, strings, conditionals, and Boolean logic (Big Idea 3).* | Follow Lesson tab |
...
Week theme: **Programming I**.  
Focus: Variables, expressions, strings, conditionals, and Boolean logic (Big Idea 3).
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w3-s1-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w3-s1-tabs.png` |
| C | Help / Coach guidance open | `csp-w3-s1-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w3-s1-editor.png` |
| E | Success / check state | `csp-w3-s1-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w3-s1-console.png` |

![Hero placeholder](../../images/csp-w3-s1-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/5` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
