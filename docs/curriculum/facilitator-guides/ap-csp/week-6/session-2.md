# Facilitator guide — AP CSP Prep · Week 6 · Session 2

**Lesson id:** `csp-12` · **URL:** `/learn/ap-csp-prep/12`
...
| Field | Value |
| --- | --- |
| **Track / lesson id** | `ap-csp-prep` / `csp-12` |
| **Title** | The Internet: Packets, Protocols & Trust |
| **Time** | 45–60 min |
| **Week theme** | Systems & Networks |
| **Student goal** | Complete **The Internet: Packets, Protocols & Trust** and demonstrate the week focus: Hardware/software, fault tolerance, packets, protocols, DNS, and HTTPS (Big Idea 4). |
| **Standards** | College Board Big Ideas (prep — not official AP) |
| **Materials** | Browser devices · projector · Create PT notes as needed |
| **XP / badge** | 600 · Network Navigator |
...
- [ ] Open `/learn/ap-csp-prep/12` on the projector (lesson loads)
...
| 5–20 | **Teach** | Walk Lesson slides; emphasize one big idea from: *Hardware/software, fault tolerance, packets, protocols, DNS, and HTTPS (Big Idea 4).* | Follow Lesson tab |
...
Week theme: **Systems & Networks**.  
Focus: Hardware/software, fault tolerance, packets, protocols, DNS, and HTTPS (Big Idea 4).
...
| ID | Capture | Filename |
| --- | --- | --- |
| A | Lesson hero / title + goal | `csp-w6-s2-hero.png` |
| B | Lesson / Exercises (or Quiz) tabs | `csp-w6-s2-tabs.png` |
| C | Help / Coach guidance open | `csp-w6-s2-help.png` |
| D | Main workspace (editor, query, or quiz) | `csp-w6-s2-editor.png` |
| E | Success / check state | `csp-w6-s2-run.png` |
| F | Evidence panel (console, chart, or score) | `csp-w6-s2-console.png` |

![Hero placeholder](../../images/csp-w6-s2-hero.png)

**Capture checklist:** local unlock → `/learn/ap-csp-prep/12` → Lesson → Practice/Quiz → success state → save under `facilitator-guides/images/`.
