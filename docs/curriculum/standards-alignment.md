...
## 1. CSTA 2017 — Algorithms & Programming

| Code | Standard (abbrev.) | Level | Lessons |
| --- | --- | :---: | --- |
| 2-AP-10 | Use flowcharts/pseudocode to express algorithms | 2 | P5, P7 |
| 2-AP-11 | Clearly named variables; data types; operations | 2 | P1, P2, P3; D2 |
...
| CSTA Concept | Level 2 (6–8) | Level 3A (9–10) |
| --- | --- | --- |
